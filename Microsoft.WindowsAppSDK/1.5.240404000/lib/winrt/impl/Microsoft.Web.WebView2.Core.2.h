...
WINRT_EXPORT namespace winrt::Microsoft::Web::WebView2::Core
{
    ...
    struct __declspec(empty_bases) CoreWebView2BrowserExtension : winrt::Microsoft::Web::WebView2::Core::ICoreWebView2BrowserExtension
    {
    ...
    struct __declspec(empty_bases) CoreWebView2ProcessExtendedInfo : winrt::Microsoft::Web::WebView2::Core::ICoreWebView2ProcessExtendedInfo
    {
