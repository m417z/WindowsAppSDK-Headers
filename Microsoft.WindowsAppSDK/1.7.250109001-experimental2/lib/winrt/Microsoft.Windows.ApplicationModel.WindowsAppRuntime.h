...
{
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_ICompatibilityOptions<D>::PatchMode1() const
    {
        winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions)->get_PatchMode1(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_ICompatibilityOptions<D>::PatchMode1(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions)->put_PatchMode1(impl::bind_in(value)));
    }
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_ICompatibilityOptions<D>::PatchMode2() const
    {
        winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions)->get_PatchMode2(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_ICompatibilityOptions<D>::PatchMode2(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions)->put_PatchMode2(impl::bind_in(value)));
    }
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_ICompatibilityOptions<D>::DisabledChanges() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions)->get_DisabledChanges(&value));
        return winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::CompatibilityChange>{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_ICompatibilityOptions<D>::Apply() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions)->Apply());
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::IDeploymentManagerStatics3)->Repair(&result));
        return winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::DeploymentResult{ result, take_ownership_from_abi };
    }
    ...
    template <typename D>
    struct produce<D, winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions> : produce_base<D, winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions>
    {
        int32_t __stdcall get_PatchMode1(struct struct_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_WindowsAppRuntimeVersion* value) noexcept final try
        {
            zero_abi<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion>(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion>(this->shim().PatchMode1());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall put_PatchMode1(struct struct_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_WindowsAppRuntimeVersion value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().PatchMode1(*reinterpret_cast<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_PatchMode2(struct struct_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_WindowsAppRuntimeVersion* value) noexcept final try
        {
            zero_abi<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion>(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion>(this->shim().PatchMode2());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall put_PatchMode2(struct struct_Microsoft_Windows_ApplicationModel_WindowsAppRuntime_WindowsAppRuntimeVersion value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().PatchMode2(*reinterpret_cast<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::WindowsAppRuntimeVersion const*>(&value));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_DisabledChanges(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::CompatibilityChange>>(this->shim().DisabledChanges());
            return 0;
        }
        catch (...) { return to_hresult(); }
...
{
    inline CompatibilityOptions::CompatibilityOptions() :
        CompatibilityOptions(impl::call_factory_cast<CompatibilityOptions(*)(winrt::Windows::Foundation::IActivationFactory const&), CompatibilityOptions>([](winrt::Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<CompatibilityOptions>(); }))
    {
    }
...
{
#ifndef WINRT_LEAN_AND_MEAN
    template<> struct hash<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions> : winrt::impl::hash_base {};
    ...
    template<> struct hash<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::CompatibilityOptions> : winrt::impl::hash_base {};
