...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    struct WINRT_IMPL_EMPTY_BASES ChildSiteLink : winrt::Microsoft::UI::Content::IChildSiteLink,
        impl::require<ChildSiteLink, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Content::IContentSiteAutomation, winrt::Microsoft::UI::Content::IContentSiteInput, winrt::Microsoft::UI::Content::IContentSiteLink, winrt::Microsoft::UI::Content::IContentSiteLink2>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ReadOnlyDesktopSiteBridge : winrt::Microsoft::UI::Content::IReadOnlyDesktopSiteBridge,
        impl::require<ReadOnlyDesktopSiteBridge, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Content::IContentSiteBridge, winrt::Microsoft::UI::Content::IContentSiteInput>
    {
        ...
        static auto Create(winrt::Microsoft::UI::Dispatching::DispatcherQueue const& queue, winrt::Microsoft::UI::WindowId const& windowId);
    };
