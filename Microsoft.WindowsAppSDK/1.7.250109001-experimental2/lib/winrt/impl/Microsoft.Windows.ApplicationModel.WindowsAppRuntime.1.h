...
{
    struct WINRT_IMPL_EMPTY_BASES ICompatibilityOptions :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICompatibilityOptions>
    {
        ICompatibilityOptions(std::nullptr_t = nullptr) noexcept {}
        ICompatibilityOptions(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
