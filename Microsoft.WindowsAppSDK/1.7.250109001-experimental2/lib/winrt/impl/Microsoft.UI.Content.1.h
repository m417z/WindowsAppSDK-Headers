...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IContentSiteLink2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IContentSiteLink2>,
        impl::require<winrt::Microsoft::UI::Content::IContentSiteLink2, winrt::Windows::Foundation::IClosable>
    {
        IContentSiteLink2(std::nullptr_t = nullptr) noexcept {}
        IContentSiteLink2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
