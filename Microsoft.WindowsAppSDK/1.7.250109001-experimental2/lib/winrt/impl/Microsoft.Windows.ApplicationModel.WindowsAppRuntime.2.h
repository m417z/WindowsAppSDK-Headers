...
WINRT_EXPORT namespace winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime
{
    ...
    struct WINRT_IMPL_EMPTY_BASES CompatibilityOptions : winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions
    {
        CompatibilityOptions(std::nullptr_t) noexcept {}
        CompatibilityOptions(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::ICompatibilityOptions(ptr, take_ownership_from_abi) {}
