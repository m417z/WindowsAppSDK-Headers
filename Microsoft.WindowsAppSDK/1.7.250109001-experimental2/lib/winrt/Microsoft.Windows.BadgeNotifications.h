...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Windows_BadgeNotifications_IBadgeNotificationManager<D>::SetBadgeAsCount(uint32_t notificationCount, winrt::Windows::Foundation::DateTime const& expiration) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::BadgeNotifications::IBadgeNotificationManager)->SetBadgeAsCount2(notificationCount, impl::bind_in(expiration)));
    }
    ...
    template <typename D> auto consume_Microsoft_Windows_BadgeNotifications_IBadgeNotificationManager<D>::SetBadgeAsGlyph(winrt::Microsoft::Windows::BadgeNotifications::BadgeNotificationGlyph const& glyphValue, winrt::Windows::Foundation::DateTime const& expiration) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::BadgeNotifications::IBadgeNotificationManager)->SetBadgeAsGlyph2(static_cast<int32_t>(glyphValue), impl::bind_in(expiration)));
    }
    ...
    struct produce<D, winrt::Microsoft::Windows::BadgeNotifications::IBadgeNotificationManager> : produce_base<D, winrt::Microsoft::Windows::BadgeNotifications::IBadgeNotificationManager>
    {
        ...
        int32_t __stdcall SetBadgeAsCount2(uint32_t notificationCount, int64_t expiration) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().SetBadgeAsCount(notificationCount, *reinterpret_cast<winrt::Windows::Foundation::DateTime const*>(&expiration));
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        int32_t __stdcall SetBadgeAsGlyph2(int32_t glyphValue, int64_t expiration) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().SetBadgeAsGlyph(*reinterpret_cast<winrt::Microsoft::Windows::BadgeNotifications::BadgeNotificationGlyph const*>(&glyphValue), *reinterpret_cast<winrt::Windows::Foundation::DateTime const*>(&expiration));
            return 0;
        }
        catch (...) { return to_hresult(); }
