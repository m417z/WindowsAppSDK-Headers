...
namespace winrt::impl
{
    ...
    template <typename D> typename consume_Microsoft_UI_Xaml_Controls_Primitives_IScrollPresenter2<D>::ScrollStarting_revoker consume_Microsoft_UI_Xaml_Controls_Primitives_IScrollPresenter2<D>::ScrollStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollPresenter, winrt::Microsoft::UI::Xaml::Controls::ScrollingScrollStartingEventArgs> const& handler) const
    {
    ...
    template <typename D> typename consume_Microsoft_UI_Xaml_Controls_Primitives_IScrollPresenter2<D>::ZoomStarting_revoker consume_Microsoft_UI_Xaml_Controls_Primitives_IScrollPresenter2<D>::ZoomStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollPresenter, winrt::Microsoft::UI::Xaml::Controls::ScrollingZoomStartingEventArgs> const& handler) const
    {
