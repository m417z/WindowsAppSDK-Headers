...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Security_Authentication_OAuth_IAuthRequestParamsStatics<D>::CreateForImplicitRequest(param::hstring const& clientId) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics)->CreateForImplicitRequest(*(void**)(&clientId), &result));
        return winrt::Microsoft::Security::Authentication::OAuth::AuthRequestParams{ result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Microsoft_Security_Authentication_OAuth_IAuthRequestParamsStatics<D>::CreateForImplicitRequest(param::hstring const& clientId, winrt::Windows::Foundation::Uri const& redirectUri) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics)->CreateForImplicitRequest2(*(void**)(&clientId), *(void**)(&redirectUri), &result));
        return winrt::Microsoft::Security::Authentication::OAuth::AuthRequestParams{ result, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Microsoft_Security_Authentication_OAuth_IOAuth2ManagerStatics<D>::RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint, winrt::Windows::Foundation::Uri const& redirectUri) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Security::Authentication::OAuth::IOAuth2ManagerStatics)->RequestAuthAsync(impl::bind_in(parentWindowId), *(void**)(&completeAuthEndpoint), *(void**)(&redirectUri), &operation));
    ...
    template <typename D> auto consume_Microsoft_Security_Authentication_OAuth_IOAuth2ManagerStatics<D>::RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Security::Authentication::OAuth::IOAuth2ManagerStatics)->RequestAuthAsync2(impl::bind_in(parentWindowId), *(void**)(&completeAuthEndpoint), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::Security::Authentication::OAuth::AuthRequestResult>{ operation, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Microsoft_Security_Authentication_OAuth_ITokenRequestParamsStatics<D>::CreateForResourceOwnerPasswordCredentials(param::hstring const& username, param::hstring const& password) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParamsStatics)->CreateForResourceOwnerPasswordCredentials(*(void**)(&username), *(void**)(&password), &result));
        return winrt::Microsoft::Security::Authentication::OAuth::TokenRequestParams{ result, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics> : produce_base<D, winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics>
    {
        ...
        int32_t __stdcall CreateForImplicitRequest(void* clientId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<winrt::Microsoft::Security::Authentication::OAuth::AuthRequestParams>(this->shim().CreateForImplicitRequest(*reinterpret_cast<hstring const*>(&clientId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall CreateForImplicitRequest2(void* clientId, void* redirectUri, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<winrt::Microsoft::Security::Authentication::OAuth::AuthRequestParams>(this->shim().CreateForImplicitRequest(*reinterpret_cast<hstring const*>(&clientId), *reinterpret_cast<winrt::Windows::Foundation::Uri const*>(&redirectUri)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        int32_t __stdcall RequestAuthAsync(struct struct_Microsoft_UI_WindowId parentWindowId, void* completeAuthEndpoint, void* redirectUri, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::Security::Authentication::OAuth::AuthRequestResult>>(this->shim().RequestAuthAsync(*reinterpret_cast<winrt::Microsoft::UI::WindowId const*>(&parentWindowId), *reinterpret_cast<winrt::Windows::Foundation::Uri const*>(&completeAuthEndpoint), *reinterpret_cast<winrt::Windows::Foundation::Uri const*>(&redirectUri)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall RequestAuthAsync2(struct struct_Microsoft_UI_WindowId parentWindowId, void* completeAuthEndpoint, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::Security::Authentication::OAuth::AuthRequestResult>>(this->shim().RequestAuthAsync(*reinterpret_cast<winrt::Microsoft::UI::WindowId const*>(&parentWindowId), *reinterpret_cast<winrt::Windows::Foundation::Uri const*>(&completeAuthEndpoint)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    struct produce<D, winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParamsStatics> : produce_base<D, winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParamsStatics>
    {
        ...
        int32_t __stdcall CreateForResourceOwnerPasswordCredentials(void* username, void* password, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<winrt::Microsoft::Security::Authentication::OAuth::TokenRequestParams>(this->shim().CreateForResourceOwnerPasswordCredentials(*reinterpret_cast<hstring const*>(&username), *reinterpret_cast<hstring const*>(&password)));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
WINRT_EXPORT namespace winrt::Microsoft::Security::Authentication::OAuth
{
    ...
    inline auto AuthRequestParams::CreateForImplicitRequest(param::hstring const& clientId)
    {
        return impl::call_factory<AuthRequestParams, IAuthRequestParamsStatics>([&](IAuthRequestParamsStatics const& f) { return f.CreateForImplicitRequest(clientId); });
    }
    inline auto AuthRequestParams::CreateForImplicitRequest(param::hstring const& clientId, winrt::Windows::Foundation::Uri const& redirectUri)
    {
        return impl::call_factory<AuthRequestParams, IAuthRequestParamsStatics>([&](IAuthRequestParamsStatics const& f) { return f.CreateForImplicitRequest(clientId, redirectUri); });
    }
    ...
    inline auto OAuth2Manager::RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint, winrt::Windows::Foundation::Uri const& redirectUri)
    {
        return impl::call_factory<OAuth2Manager, IOAuth2ManagerStatics>([&](IOAuth2ManagerStatics const& f) { return f.RequestAuthAsync(parentWindowId, completeAuthEndpoint, redirectUri); });
    }
    inline auto OAuth2Manager::RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint)
    {
        return impl::call_factory<OAuth2Manager, IOAuth2ManagerStatics>([&](IOAuth2ManagerStatics const& f) { return f.RequestAuthAsync(parentWindowId, completeAuthEndpoint); });
    }
    ...
    inline auto TokenRequestParams::CreateForResourceOwnerPasswordCredentials(param::hstring const& username, param::hstring const& password)
    {
        return impl::call_factory<TokenRequestParams, ITokenRequestParamsStatics>([&](ITokenRequestParamsStatics const& f) { return f.CreateForResourceOwnerPasswordCredentials(username, password); });
    }
