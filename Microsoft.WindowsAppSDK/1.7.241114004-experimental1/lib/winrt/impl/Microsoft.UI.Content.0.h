...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IChildContentLink>{ 0xDBD49E4A,0xB298,0x58F3,{ 0xBB,0xBF,0xBF,0x7E,0xD3,0x21,0xE4,0x64 } }; // DBD49E4A-B298-58F3-BBBF-BF7ED321E464
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentIsland3>{ 0x260F6BBC,0x58F7,0x5EFC,{ 0xBC,0x8D,0x0D,0xEB,0xF8,0x3C,0x10,0xE6 } }; // 260F6BBC-58F7-5EFC-BC8D-0DEBF83C10E6
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSite3>{ 0xB628A15C,0x986D,0x5E67,{ 0x87,0x67,0x33,0xDD,0xEC,0x3A,0x62,0xEA } }; // B628A15C-986D-5E67-8767-33DDEC3A62EA
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSiteBridge2>{ 0x4367E9DC,0x85EF,0x538D,{ 0x9C,0xAE,0x37,0x75,0x00,0x78,0x1C,0x35 } }; // 4367E9DC-85EF-538D-9CAE-377500781C35
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSiteView2>{ 0xF1D3AA18,0x2B4E,0x58C8,{ 0xA5,0x23,0xD3,0x6B,0xC4,0xE2,0x59,0x61 } }; // F1D3AA18-2B4E-58C8-A523-D36BC4E25961
    ...
    struct consume_Microsoft_UI_Content_IChildContentLink
    {
        ...
        auto SetIsInputPassThrough(bool value) const;
    };
    ...
    struct consume_Microsoft_UI_Content_IChildContentLinkStatics
    {
        ...
        auto Create(winrt::Microsoft::UI::Content::ContentIsland const& parent, winrt::Windows::UI::Composition::ContainerVisual const& placementVisual) const;
    };
    ...
    {
        auto Create(winrt::Microsoft::UI::Composition::Compositor const& compositor, winrt::Windows::UI::Composition::Visual const& root) const;
        auto FindAllForCompositor(winrt::Windows::UI::Composition::Compositor const& compositor) const;
        auto GetByVisual(winrt::Windows::UI::Composition::Visual const& child) const;
    };
    ...
    {
        [[nodiscard]] auto Compositor() const;
        [[nodiscard]] auto SiteVisual() const;
        auto SetContentNodeParent(winrt::Microsoft::UI::Content::IContentNodeOwner const& value) const;
    ...
    {
        [[nodiscard]] auto AutomationOption() const;
        auto AutomationOption(winrt::Microsoft::UI::Content::AutomationOptions const& value) const;
        [[nodiscard]] auto AutomationProvider() const;
        auto FragmentRootAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        ...
        auto NextSiblingAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        ...
        auto ParentAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        ...
        auto PreviousSiblingAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
    ...
    {
        auto Create(winrt::Microsoft::UI::Composition::Compositor const& compositor, winrt::Microsoft::UI::WindowId const& windowId) const;
    };
    ...
    {
        auto Create(winrt::Microsoft::UI::Composition::Compositor const& localCompositor, winrt::Windows::UI::Composition::ContainerVisual const& hostVisual, winrt::Microsoft::UI::WindowId const& parentForInputWindowId) const;
    };
