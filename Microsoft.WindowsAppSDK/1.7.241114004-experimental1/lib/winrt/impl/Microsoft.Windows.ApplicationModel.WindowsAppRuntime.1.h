...
WINRT_EXPORT namespace winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime
{
    ...
    struct __declspec(empty_bases) IDeploymentManagerStatics3 :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IReleaseInfoStatics :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IRuntimeInfoStatics :
        winrt::Windows::Foundation::IInspectable,
