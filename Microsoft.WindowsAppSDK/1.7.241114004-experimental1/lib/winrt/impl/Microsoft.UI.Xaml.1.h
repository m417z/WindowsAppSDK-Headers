...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml
{
    ...
    struct __declspec(empty_bases) IXamlRoot3 :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IXamlRootFeature_ExperimentalApi :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IXamlRootFeature_ExperimentalApi>
    {
        IXamlRootFeature_ExperimentalApi(std::nullptr_t = nullptr) noexcept {}
        IXamlRootFeature_ExperimentalApi(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
