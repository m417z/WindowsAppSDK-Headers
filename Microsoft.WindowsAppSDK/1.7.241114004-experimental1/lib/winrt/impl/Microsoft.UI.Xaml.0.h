...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::IXamlRootFeature_ExperimentalApi>{ 0x31D66939,0xD570,0x5CB8,{ 0xAB,0x83,0x9E,0x87,0x25,0x72,0xF2,0xD8 } }; // 31D66939-D570-5CB8-AB83-9E872572F2D8
    ...
    {
        auto TryGetContentIsland() const;
    };
