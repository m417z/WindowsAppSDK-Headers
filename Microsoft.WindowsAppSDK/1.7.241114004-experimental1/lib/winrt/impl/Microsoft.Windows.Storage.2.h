...
{
    struct __declspec(empty_bases) ApplicationData : winrt::Microsoft::Windows::Storage::IApplicationData,
    ...
    struct __declspec(empty_bases) ApplicationDataContainer : winrt::Microsoft::Windows::Storage::IApplicationDataContainer,
