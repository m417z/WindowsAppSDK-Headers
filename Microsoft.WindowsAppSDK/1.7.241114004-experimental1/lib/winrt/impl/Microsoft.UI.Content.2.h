...
{
    struct WINRT_IMPL_EMPTY_BASES ChildContentLink : winrt::Microsoft::UI::Content::IChildContentLink,
        impl::require<ChildContentLink, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Content::IContentLink, winrt::Microsoft::UI::Content::IContentSiteBridge2, winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ContentIsland : winrt::Microsoft::UI::Content::IContentIsland,
        impl::require<ContentIsland, winrt::Microsoft::UI::Content::IContentIsland2, winrt::Microsoft::UI::Content::IContentIsland3, winrt::Microsoft::UI::Content::IContentIslandAutomation, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Composition::ICompositionSupportsSystemBackdrop, winrt::Microsoft::UI::Content::IContentIslandEndpointConnectionPrivate>
    {
        ...
        static auto Create(winrt::Microsoft::UI::Composition::Compositor const& compositor, winrt::Windows::UI::Composition::Visual const& root);
    ...
    struct WINRT_IMPL_EMPTY_BASES ContentIslandEnvironment : winrt::Microsoft::UI::Content::IContentIslandEnvironment,
        impl::require<ContentIslandEnvironment, winrt::Microsoft::UI::Content::IContentIslandEnvironment2, winrt::Microsoft::UI::Content::IContentIslandEnvironment3>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES ReadOnlyDesktopSiteBridge : winrt::Microsoft::UI::Content::IReadOnlyDesktopSiteBridge,
