...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Printing_IPrintDocument
    {
        ...
        [[nodiscard]] Paginate_revoker Paginate(auto_revoke_t, winrt::Microsoft::UI::Xaml::Printing::PaginateEventHandler const& handler) const;
        ...
        [[nodiscard]] GetPreviewPage_revoker GetPreviewPage(auto_revoke_t, winrt::Microsoft::UI::Xaml::Printing::GetPreviewPageEventHandler const& handler) const;
        ...
        [[nodiscard]] AddPages_revoker AddPages(auto_revoke_t, winrt::Microsoft::UI::Xaml::Printing::AddPagesEventHandler const& handler) const;
