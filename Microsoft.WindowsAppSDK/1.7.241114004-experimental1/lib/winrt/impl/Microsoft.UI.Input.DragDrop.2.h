...
{
    struct __declspec(empty_bases) DragDropManager : winrt::Microsoft::UI::Input::DragDrop::IDragDropManager,
    ...
    struct __declspec(empty_bases) DragInfo : winrt::Microsoft::UI::Input::DragDrop::IDragInfo
    {
    ...
    struct __declspec(empty_bases) DragOperation : winrt::Microsoft::UI::Input::DragDrop::IDragOperation,
    ...
    struct __declspec(empty_bases) DragUIOverride : winrt::Microsoft::UI::Input::DragDrop::IDragUIOverride
    {
    ...
    struct __declspec(empty_bases) DropOperationTargetRequestedEventArgs : winrt::Microsoft::UI::Input::DragDrop::IDropOperationTargetRequestedEventArgs
    {
