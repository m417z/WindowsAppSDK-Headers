...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Controls_Primitives_IScrollPresenter2
    {
        ...
        [[nodiscard]] ScrollStarting_revoker ScrollStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollPresenter, winrt::Microsoft::UI::Xaml::Controls::ScrollingScrollStartingEventArgs> const& handler) const;
        ...
        [[nodiscard]] ZoomStarting_revoker ZoomStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollPresenter, winrt::Microsoft::UI::Xaml::Controls::ScrollingZoomStartingEventArgs> const& handler) const;
