...
WINRT_EXPORT namespace winrt::Microsoft::UI::Composition
{
    ...
    struct __declspec(empty_bases) ICompositionNotificationDeferral :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IExpCompositionProjectedShadow :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IExpCompositionProjectedShadowCaster :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IExpCompositionProjectedShadowReceiver :
        winrt::Windows::Foundation::IInspectable,
