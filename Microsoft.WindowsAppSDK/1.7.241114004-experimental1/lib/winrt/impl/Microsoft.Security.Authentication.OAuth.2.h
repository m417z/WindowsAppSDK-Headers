...
{
    struct __declspec(empty_bases) AuthFailure : winrt::Microsoft::Security::Authentication::OAuth::IAuthFailure
    {
    ...
    struct __declspec(empty_bases) AuthRequestParams : winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParams
    {
        ...
        static auto CreateForImplicitRequest(param::hstring const& clientId);
        static auto CreateForImplicitRequest(param::hstring const& clientId, winrt::Windows::Foundation::Uri const& redirectUri);
    };
    struct __declspec(empty_bases) AuthRequestResult : winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestResult
    {
    ...
    struct __declspec(empty_bases) AuthResponse : winrt::Microsoft::Security::Authentication::OAuth::IAuthResponse
    {
    ...
    struct __declspec(empty_bases) ClientAuthentication : winrt::Microsoft::Security::Authentication::OAuth::IClientAuthentication
    {
    ...
    struct OAuth2Manager
    {
        ...
        static auto RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint, winrt::Windows::Foundation::Uri const& redirectUri);
        static auto RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint);
    ...
    struct __declspec(empty_bases) TokenFailure : winrt::Microsoft::Security::Authentication::OAuth::ITokenFailure
    {
    ...
    struct __declspec(empty_bases) TokenRequestParams : winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParams
    {
        ...
        static auto CreateForResourceOwnerPasswordCredentials(param::hstring const& username, param::hstring const& password);
    ...
    struct __declspec(empty_bases) TokenRequestResult : winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestResult
    {
    ...
    struct __declspec(empty_bases) TokenResponse : winrt::Microsoft::Security::Authentication::OAuth::ITokenResponse
    {
