...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics>{ 0x62016F03,0x865F,0x5D1A,{ 0x9F,0x3B,0xB8,0x03,0x55,0x6D,0x9B,0xCC } }; // 62016F03-865F-5D1A-9F3B-B803556D9BCC
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Security::Authentication::OAuth::IOAuth2ManagerStatics>{ 0x697D9F49,0xE470,0x561C,{ 0xBC,0xC3,0x75,0x30,0xB3,0xF6,0xC6,0x5E } }; // 697D9F49-E470-561C-BCC3-7530B3F6C65E
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParamsStatics>{ 0x632B6094,0xF20A,0x5183,{ 0xB9,0x24,0x54,0xD4,0x30,0xD4,0x00,0x50 } }; // 632B6094-F20A-5183-B924-54D430D40050
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall CreateForImplicitRequest(void*, void**) noexcept = 0;
            virtual int32_t __stdcall CreateForImplicitRequest2(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IOAuth2ManagerStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall RequestAuthAsync(struct struct_Microsoft_UI_WindowId, void*, void*, void**) noexcept = 0;
            virtual int32_t __stdcall RequestAuthAsync2(struct struct_Microsoft_UI_WindowId, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParamsStatics>
    {
        ...
        {
            virtual int32_t __stdcall CreateForAuthorizationCodeRequest(void*, void**) noexcept = 0;
            virtual int32_t __stdcall CreateForResourceOwnerPasswordCredentials(void*, void*, void**) noexcept = 0;
    ...
    struct consume_Microsoft_Security_Authentication_OAuth_IAuthRequestParamsStatics
    {
        ...
        auto CreateForImplicitRequest(param::hstring const& clientId) const;
        auto CreateForImplicitRequest(param::hstring const& clientId, winrt::Windows::Foundation::Uri const& redirectUri) const;
    };
    ...
    {
        auto RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint, winrt::Windows::Foundation::Uri const& redirectUri) const;
        auto RequestAuthAsync(winrt::Microsoft::UI::WindowId const& parentWindowId, winrt::Windows::Foundation::Uri const& completeAuthEndpoint) const;
    ...
    struct consume_Microsoft_Security_Authentication_OAuth_ITokenRequestParamsStatics
    {
        ...
        auto CreateForResourceOwnerPasswordCredentials(param::hstring const& username, param::hstring const& password) const;
