...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Data_ICollectionView
    {
        ...
        [[nodiscard]] CurrentChanging_revoker CurrentChanging(auto_revoke_t, winrt::Microsoft::UI::Xaml::Data::CurrentChangingEventHandler const& handler) const;
    ...
    struct consume_Microsoft_UI_Xaml_Data_INotifyDataErrorInfo
    {
        ...
        [[nodiscard]] ErrorsChanged_revoker ErrorsChanged(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Data::DataErrorsChangedEventArgs> const& handler) const;
    ...
    struct consume_Microsoft_UI_Xaml_Data_INotifyPropertyChanged
    {
        ...
        [[nodiscard]] PropertyChanged_revoker PropertyChanged(auto_revoke_t, winrt::Microsoft::UI::Xaml::Data::PropertyChangedEventHandler const& handler) const;
