...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_UI_Windowing_IAppWindow4<D>::DefaultTitleBarShouldMatchAppModeTheme() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Windowing::IAppWindow4)->get_DefaultTitleBarShouldMatchAppModeTheme(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Windowing_IAppWindow4<D>::DefaultTitleBarShouldMatchAppModeTheme(bool value) const
    {
