...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentIsland2<D>::Connected(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Content::ContentIsland> const& handler) const
    {
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentIsland2<D>::Disconnected(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Content::ContentIsland> const& handler) const
    {
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentIslandEnvironment2<D>::ThemeChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::ContentIslandEnvironment, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteBridgeAutomation<D>::FragmentRootAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const
    {
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteBridgeAutomation<D>::ParentAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const
    {
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteBridgeAutomation<D>::PreviousSiblingAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const
    {
