...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml
{
    ...
    struct IXamlRootFeature_ExperimentalApi;
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::IXamlRootFeature_ExperimentalApi>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::IXamlRootFeature_ExperimentalApi> = L"Microsoft.UI.Xaml.IXamlRootFeature_ExperimentalApi";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::IXamlRootFeature_ExperimentalApi>{ 0xCF44E461,0xDD83,0x5E84,{ 0xB1,0xEB,0x6F,0x9C,0xA5,0xBB,0xD8,0xE5 } }; // CF44E461-DD83-5E84-B1EB-6F9CA5BBD8E5
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::IXamlRootFeature_ExperimentalApi>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_CoordinateConverter(void**) noexcept = 0;
            virtual int32_t __stdcall TryGetContentIsland(void**) noexcept = 0;
        };
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_IXamlRootFeature_ExperimentalApi
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Content::ContentCoordinateConverter) CoordinateConverter() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Content::ContentIsland) TryGetContentIsland() const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::IXamlRootFeature_ExperimentalApi>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_IXamlRootFeature_ExperimentalApi<D>;
    };
    template <typename D>
