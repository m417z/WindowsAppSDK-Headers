...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Controls
{
    ...
    struct ScrollingViewChangingEventArgs;
...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollPresenter2>{ 0x4B5DA24C,0xE22E,0x59B2,{ 0x81,0x2A,0x82,0xBB,0x9E,0x59,0xA9,0xA6 } }; // 4B5DA24C-E22E-59B2-812A-82BB9E59A9A6
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) ViewChanging(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollPresenter, winrt::Microsoft::UI::Xaml::Controls::ScrollingViewChangingEventArgs> const& handler) const;
        using ViewChanging_revoker = impl::event_revoker<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollPresenter2, &impl::abi_t<winrt::Microsoft::UI::Xaml::Controls::Primitives::IScrollPresenter2>::remove_ViewChanging>;
        [[nodiscard]] ViewChanging_revoker ViewChanging(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollPresenter, winrt::Microsoft::UI::Xaml::Controls::ScrollingViewChangingEventArgs> const& handler) const;
