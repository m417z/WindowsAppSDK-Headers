...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::GetEnvironmentVariables, &result);
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::GetEnvironmentVariable, *(void**)(&name), &result);
    ...
    {
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::SetEnvironmentVariable, *(void**)(&name), *(void**)(&value));
    }
    ...
    {
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::AppendToPath, *(void**)(&path));
    }
    ...
    {
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::RemoveFromPath, *(void**)(&path));
    }
    ...
    {
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::AddExecutableFileExtension, *(void**)(&pathExt));
    }
    ...
    {
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager>::RemoveExecutableFileExtension, *(void**)(&pathExt));
    }
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManager2<D>::AreChangesTracked() const
    {
        bool value{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManager2, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManager2>::get_AreChangesTracked, &value);
        return value;
    }
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManagerStatics<D>::GetForProcess() const
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics>::GetForProcess, &result);
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics>::GetForUser, &result);
        return winrt::Microsoft::Windows::System::EnvironmentManager{ result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManagerStatics<D>::GetForMachine() const
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics>::GetForMachine, &result);
        return winrt::Microsoft::Windows::System::EnvironmentManager{ result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Microsoft_Windows_System_IEnvironmentManagerStatics<D>::IsSupported() const
    {
        bool value{};
        consume_general<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics>::get_IsSupported, &value);
        return value;
    }
    ...
    {
        std::int32_t __stdcall GetEnvironmentVariables(void** result) noexcept final try
        {
            clear_abi(result);
        ...
        std::int32_t __stdcall GetEnvironmentVariable(void* name, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall SetEnvironmentVariable(void* name, void* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall AppendToPath(void* path) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall RemoveFromPath(void* path) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall AddExecutableFileExtension(void* pathExt) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall RemoveExecutableFileExtension(void* pathExt) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_AreChangesTracked(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall GetForProcess(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall GetForUser(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall GetForMachine(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
