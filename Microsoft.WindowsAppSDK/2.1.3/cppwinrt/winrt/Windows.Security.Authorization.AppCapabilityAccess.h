...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2>::get_DisplayMessage, &value);
        return hstring{ value, take_ownership_from_abi };
    }
