...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_IFullTrustProcessLaunchResult<D>::LaunchResult() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::IFullTrustProcessLaunchResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::IFullTrustProcessLaunchResult>::get_LaunchResult, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    template <typename D> auto consume_Windows_ApplicationModel_IFullTrustProcessLaunchResult<D>::ExtendedError() const
    {
        winrt::hresult value{};
        consume_general<winrt::Windows::ApplicationModel::IFullTrustProcessLaunchResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::IFullTrustProcessLaunchResult>::get_ExtendedError, put_abi(value));
        return value;
    }
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::IFullTrustProcessLauncherStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::IFullTrustProcessLauncherStatics2>::LaunchFullTrustProcessForCurrentAppWithArgumentsAsync, *(void**)(&commandLine), &operation);
    ...
    {
        void* operation{};
        consume_general<winrt::Windows::ApplicationModel::IFullTrustProcessLauncherStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::IFullTrustProcessLauncherStatics2>::LaunchFullTrustProcessForAppWithArgumentsAsync, *(void**)(&fullTrustPackageRelativeAppId), *(void**)(&commandLine), &operation);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::FullTrustProcessLaunchResult>{ operation, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall get_LaunchResult(std::int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall LaunchFullTrustProcessForCurrentAppWithArgumentsAsync(void* commandLine, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall LaunchFullTrustProcessForAppWithArgumentsAsync(void* fullTrustPackageRelativeAppId, void* commandLine, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
