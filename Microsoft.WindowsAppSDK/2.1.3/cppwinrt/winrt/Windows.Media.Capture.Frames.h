...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Media::Capture::Frames::IMediaFrameSourceInfo4, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Capture::Frames::IMediaFrameSourceInfo4>::get_IsShareable, &value);
        return value;
    }
    ...
    {
        std::int32_t __stdcall get_IsShareable(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
