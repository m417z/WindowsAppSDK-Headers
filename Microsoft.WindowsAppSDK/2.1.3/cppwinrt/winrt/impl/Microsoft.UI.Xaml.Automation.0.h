...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Automation::IAutomationPropertiesStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AutomationControlTypeProperty(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAutomationControlType(void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetAutomationControlType(void*, std::int32_t) noexcept = 0;
        };
    };
    ...
    struct consume_Microsoft_UI_Xaml_Automation_IAutomationPropertiesStatics
    {
        ...
        auto SetPositionInSet(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        [[nodiscard]] auto SizeOfSetProperty() const;
        auto GetSizeOfSet(winrt::Microsoft::UI::Xaml::DependencyObject const& element) const;
        auto SetSizeOfSet(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        [[nodiscard]] auto LevelProperty() const;
        auto GetLevel(winrt::Microsoft::UI::Xaml::DependencyObject const& element) const;
        auto SetLevel(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        [[nodiscard]] auto AnnotationsProperty() const;
        ...
        auto SetCulture(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        [[nodiscard]] auto HeadingLevelProperty() const;
