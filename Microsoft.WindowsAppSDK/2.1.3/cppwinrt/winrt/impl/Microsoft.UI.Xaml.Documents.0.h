...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Documents::TextRange>{ using type = struct_category<std::int32_t, std::int32_t>; };
    ...
    struct consume_Microsoft_UI_Xaml_Documents_ITextPointer
    {
        ...
        auto GetPositionAtOffset(std::int32_t offset, winrt::Microsoft::UI::Xaml::Documents::LogicalDirection const& direction) const;
    };
    ...
    struct consume_Microsoft_UI_Xaml_Documents_ITypographyStatics
    {
        ...
        auto SetAnnotationAlternates(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        ...
        auto SetStandardSwashes(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        ...
        auto SetContextualSwashes(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
        ...
        auto SetStylisticAlternates(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value) const;
