...
WINRT_EXPORT namespace winrt::Microsoft::UI::Input::DragDrop
{
    ...
    enum class DragUIContentMode : std::int32_t
    {
        Auto = 0,
        Deferred = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Input::DragDrop::IDragOperation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Data(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DragUIContentMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DragUIContentMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetDragUIContentFromSoftwareBitmap(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetDragUIContentFromSoftwareBitmap2(void*, winrt::Windows::Foundation::Point) noexcept = 0;
            virtual std::int32_t __stdcall StartAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Input::DragDrop::IDragUIOverride>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SetContentFromSoftwareBitmap2(void*, winrt::Windows::Foundation::Point) noexcept = 0;
        };
    };
