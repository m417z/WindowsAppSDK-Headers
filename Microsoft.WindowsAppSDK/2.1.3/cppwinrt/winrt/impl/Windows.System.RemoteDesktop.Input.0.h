...
{
    enum class RemoteKeyEventAttributes : std::uint32_t
    {
        None = 0,
        KeyUp = 0x1,
        Repeat = 0x2,
    ...
    enum class RemoteTextConnectionOptions : std::uint32_t
    {
        None = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall RegisterThread(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterThread(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall ReportDataReceived(std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReportPredictedKeyEvent(std::uint16_t, std::uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(winrt::guid, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(winrt::guid, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler>
    {
        ...
        {
            virtual std::int32_t __stdcall Invoke(std::uint32_t, std::uint8_t*, bool*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection
    {
        ...
        auto RegisterThread(std::uint32_t threadId) const;
        auto UnregisterThread(std::uint32_t threadId) const;
        auto ReportDataReceived(array_view<std::uint8_t const> pduData) const;
    };
    ...
    {
        auto ReportPredictedKeyEvent(std::uint16_t scanCode, winrt::Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes const& attributes) const;
    };
