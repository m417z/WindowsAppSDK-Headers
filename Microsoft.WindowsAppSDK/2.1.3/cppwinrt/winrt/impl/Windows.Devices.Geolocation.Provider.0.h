...
{
    enum class LocationOverrideStatus : std::int32_t
    {
        Success = 0,
        AccessDenied = 1,
        AlreadyStarted = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Geolocation::Provider::IGeolocationProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall get_IsOverridden(bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetOverridePosition(struct struct_Windows_Devices_Geolocation_BasicGeoposition, std::int32_t, double, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ClearOverridePosition() noexcept = 0;
            virtual std::int32_t __stdcall add_IsOverriddenChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsOverriddenChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
