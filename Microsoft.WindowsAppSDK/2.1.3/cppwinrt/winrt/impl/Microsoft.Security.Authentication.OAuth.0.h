...
{
    enum class CodeChallengeMethodKind : std::int32_t
    {
        None = 0,
        S256 = 1,
        Plain = 2,
    };
    enum class TokenFailureKind : std::int32_t
    {
        ErrorResponse = 0,
        HttpFailure = 1,
        InvalidResponse = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IAuthFailure>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ErrorDescription(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ErrorUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_State(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AdditionalParams(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParams>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ResponseType(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ResponseType(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ClientId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ClientId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_RedirectUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RedirectUri(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_State(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_State(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Scope(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Scope(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CodeChallenge(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CodeChallenge(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CodeChallengeMethod(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CodeChallengeMethod(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AdditionalParams(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestParamsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateForAuthorizationCodeRequest(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForAuthorizationCodeRequest2(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IAuthRequestResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ResponseUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Response(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Failure(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IAuthResponse>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AccessToken(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TokenType(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExpiresIn(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Scope(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AdditionalParams(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IClientAuthentication>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AdditionalHeaders(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IClientAuthenticationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateForBasicAuthorization(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::IOAuth2ManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestAuthWithParamsAsync(struct struct_Microsoft_UI_WindowId, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CompleteAuthRequest(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall RequestTokenAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestTokenAsync2(void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParams>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_GrantType(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_GrantType(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Code(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Code(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_RedirectUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RedirectUri(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CodeVerifier(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CodeVerifier(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_ClientId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ClientId(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_Scope(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Scope(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_RefreshToken(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RefreshToken(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AdditionalParams(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::ITokenRequestParamsStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall CreateForAuthorizationCodeRequest(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForClientCredentials(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForExtension(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForRefreshToken(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Security::Authentication::OAuth::ITokenResponse>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AccessToken(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TokenType(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExpiresIn(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_RefreshToken(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Scope(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AdditionalParams(void**) noexcept = 0;
        };
