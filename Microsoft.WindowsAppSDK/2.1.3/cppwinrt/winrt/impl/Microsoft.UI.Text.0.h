...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Text::ITextDocument2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetMathMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetMathMode(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetMathML(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetMathML(void*) noexcept = 0;
        };
    };
    ...
    struct consume_Microsoft_UI_Text_ITextParagraphFormat
    {
        ...
        auto GetClone() const;
        auto GetTab(std::int32_t index, float& position, winrt::Microsoft::UI::Text::TabAlignment& align, winrt::Microsoft::UI::Text::TabLeader& leader) const;
    ...
    struct consume_Microsoft_UI_Text_ITextRange
    {
        ...
        auto Copy() const;
        auto Cut() const;
        auto Delete(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        ...
        auto FindText(param::hstring const& value, std::int32_t scanLength, winrt::Microsoft::UI::Text::FindOptions const& options) const;
        ...
        auto GetRect(winrt::Microsoft::UI::Text::PointOptions const& options, winrt::Windows::Foundation::Rect& rect, std::int32_t& hit) const;
        auto GetText(winrt::Microsoft::UI::Text::TextGetOptions const& options, hstring& value) const;
        ...
        auto InsertImage(std::int32_t width, std::int32_t height, std::int32_t ascent, winrt::Microsoft::UI::Text::VerticalCharacterAlignment const& verticalAlign, param::hstring const& alternateText, winrt::Windows::Storage::Streams::IRandomAccessStream const& value) const;
        ...
        auto Move(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        auto MoveEnd(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        auto MoveStart(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count) const;
        ...
        auto SetIndex(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t index, bool extend) const;
    ...
    struct consume_Microsoft_UI_Text_ITextSelection
    {
        ...
        auto MoveDown(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
        auto MoveLeft(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
        auto MoveRight(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
        auto MoveUp(winrt::Microsoft::UI::Text::TextRangeUnit const& unit, std::int32_t count, bool extend) const;
