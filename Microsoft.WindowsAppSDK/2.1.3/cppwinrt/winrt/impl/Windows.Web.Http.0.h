...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Web::Http::IHttpClient3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DefaultPrivacyAnnotation(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DefaultPrivacyAnnotation(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Web::Http::IHttpRequestMessage2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PrivacyAnnotation(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PrivacyAnnotation(void*) noexcept = 0;
        };
    };
