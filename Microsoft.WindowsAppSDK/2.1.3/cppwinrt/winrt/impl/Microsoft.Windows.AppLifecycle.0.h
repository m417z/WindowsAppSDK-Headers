...
{
    enum class ExtendedActivationKind : std::int32_t
    {
        Launch = 0,
        Search = 1,
        ShareTarget = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppLifecycle::IActivationRegistrationManagerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall RegisterForFileTypeActivation(std::uint32_t, void**, void*, void*, std::uint32_t, void**, void*) noexcept = 0;
            virtual std::int32_t __stdcall RegisterForProtocolActivation(void*, void*, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall RegisterForStartupActivation(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterForFileTypeActivation(std::uint32_t, void**, void*) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterForProtocolActivation(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall UnregisterForStartupActivation(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppLifecycle::IAppInstance>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall UnregisterKey() noexcept = 0;
            virtual std::int32_t __stdcall RedirectActivationToAsync(void*, void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_IsCurrent(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppLifecycle::IAppInstanceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall FindOrRegisterForKey(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AppLifecycle::IAppInstanceStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Restart(void*, std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
