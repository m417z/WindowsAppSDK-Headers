...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_UI_System_IThemeSettings<D>::Changed(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::System::ThemeSettings, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        ...
        consume_general<winrt::Microsoft::UI::System::IThemeSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::System::IThemeSettings>::add_Changed, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Microsoft::UI::System::IThemeSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::System::IThemeSettings>::remove_Changed, impl::bind_in(token));
    }
    template <typename D> auto consume_Microsoft_UI_System_IThemeSettings<D>::HighContrast() const
    {
        bool value{};
        consume_general<winrt::Microsoft::UI::System::IThemeSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::System::IThemeSettings>::get_HighContrast, &value);
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_System_IThemeSettings<D>::HighContrastScheme() const
    {
        void* value{};
        consume_general<winrt::Microsoft::UI::System::IThemeSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::System::IThemeSettings>::get_HighContrastScheme, &value);
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::UI::System::IThemeSettingsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::System::IThemeSettingsStatics>::CreateForWindowId, impl::bind_in(windowId), &result);
