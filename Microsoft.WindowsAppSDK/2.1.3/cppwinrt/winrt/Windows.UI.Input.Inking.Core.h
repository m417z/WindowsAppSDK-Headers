...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::UI::Input::Inking::Core::ICoreInkIndependentInputSource2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Input::Inking::Core::ICoreInkIndependentInputSource2>::get_PointerCursor, &value);
