...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Graphics_ImagingInternal_IDetectFacesResult<D>::Faces() const
    {
        ...
        void** value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Graphics::ImagingInternal::IDetectFacesResult>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Graphics::ImagingInternal::IDetectFacesResult, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Graphics::ImagingInternal::IDetectFacesResult>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_Faces(&value_impl_size, &value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Graphics::ImagingInternal::IDetectFacesResult>**)this;
            check_hresult(_winrt_abi_type->get_Faces(&value_impl_size, &value));
        }
    ...
    template <typename D> auto consume_Microsoft_Graphics_ImagingInternal_IDetectedFace<D>::FaceBoundingBox() const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Graphics::ImagingInternal::IDetectedFace>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Graphics::ImagingInternal::IDetectedFace, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Graphics::ImagingInternal::IDetectedFace>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_FaceBoundingBox(put_abi(value)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Graphics::ImagingInternal::IDetectedFace>**)this;
            check_hresult(_winrt_abi_type->get_FaceBoundingBox(put_abi(value)));
        }
        return value;
    }
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->DetectFacesInRegion(*(void**)(&imageBufferResource), impl::bind_in(region), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession>**)this;
            check_hresult(_winrt_abi_type->DetectFacesInRegion(*(void**)(&imageBufferResource), impl::bind_in(region), &result));
        }
    ...
    {
        int32_t __stdcall DetectFacesInRegion(void* imageBufferResource, struct struct_Windows_Graphics_Imaging_BitmapBounds region, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
