...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml
{
    ...
    struct __declspec(empty_bases) IApplicationFeature_ExperimentalApi :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IApplicationFeature_ExperimentalApi>
    {
        IApplicationFeature_ExperimentalApi(std::nullptr_t = nullptr) noexcept {}
        IApplicationFeature_ExperimentalApi(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
