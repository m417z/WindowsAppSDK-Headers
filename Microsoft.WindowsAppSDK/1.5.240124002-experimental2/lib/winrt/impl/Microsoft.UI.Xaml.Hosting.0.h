...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Hosting
{
    ...
    struct IWindowsXamlManagerFeature_ExperimentalApi;
    struct IWindowsXamlManagerStatics;
    struct IWindowsXamlManagerStaticsFeature_ExperimentalApi;
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi> = L"Microsoft.UI.Xaml.Hosting.IWindowsXamlManagerFeature_ExperimentalApi";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi> = L"Microsoft.UI.Xaml.Hosting.IWindowsXamlManagerStaticsFeature_ExperimentalApi";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi>{ 0x80F148EC,0xB02B,0x5222,{ 0xA6,0x82,0x8F,0xF7,0x61,0x02,0xDC,0xC3 } }; // 80F148EC-B02B-5222-A682-8FF76102DCC3
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi>{ 0xBA33A2E9,0x3486,0x50DB,{ 0x98,0x2A,0xA1,0x02,0x15,0x2B,0x29,0xCA } }; // BA33A2E9-3486-50DB-982A-A102152B29CA
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_IsXamlRunningOnCurrentThread(bool*) noexcept = 0;
        };
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerFeature_ExperimentalApi
    {
        WINRT_IMPL_AUTO(winrt::event_token) XamlShutdownCompletedOnThread(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const;
        using XamlShutdownCompletedOnThread_revoker = impl::event_revoker<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi, &impl::abi_t<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi>::remove_XamlShutdownCompletedOnThread>;
        [[nodiscard]] XamlShutdownCompletedOnThread_revoker XamlShutdownCompletedOnThread(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) XamlShutdownCompletedOnThread(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerFeature_ExperimentalApi<D>;
    };
    template <typename D>
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerStaticsFeature_ExperimentalApi
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsXamlRunningOnCurrentThread() const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerStaticsFeature_ExperimentalApi<D>;
    };
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Hosting_IXamlShutdownCompletedOnThreadEventArgs
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Deferral) GetDispatcherQueueDeferral() const;
    };
