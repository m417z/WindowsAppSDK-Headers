...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Hosting
{
    ...
    struct __declspec(empty_bases) WindowsXamlManager : winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager,
        impl::require<WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi, winrt::Windows::Foundation::IClosable>
    {
        ...
        [[nodiscard]] static auto IsXamlRunningOnCurrentThread();
    };
    struct __declspec(empty_bases) XamlShutdownCompletedOnThreadEventArgs : winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs
    {
