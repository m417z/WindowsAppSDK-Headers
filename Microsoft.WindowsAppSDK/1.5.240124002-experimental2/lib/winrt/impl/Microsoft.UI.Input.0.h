...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Input::IInputKeyboardSource3>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Input::IInputKeyboardSource3> = L"Microsoft.UI.Input.IInputKeyboardSource3";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Input::IFocusNavigationRequest>{ 0x6994EF78,0xB23E,0x5438,{ 0x8E,0x9C,0x27,0x27,0x77,0xA9,0x58,0x57 } }; // 6994EF78-B23E-5438-8E9C-272777A95857
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Input::IFocusNavigationRequestEventArgs>{ 0x2C2D2C7D,0x891B,0x510E,{ 0xA7,0x86,0xBE,0x76,0xAF,0x3A,0xAB,0xCF } }; // 2C2D2C7D-891B-510E-A786-BE76AF3AABCF
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Input::IFocusNavigationRequestStatics>{ 0xDF1F589B,0x6CBE,0x595B,{ 0x8F,0x4A,0x29,0x43,0x16,0xFA,0x0A,0xE2 } }; // DF1F589B-6CBE-595B-8F4A-294316FA0AE2
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Input::IInputFocusController2>{ 0x7830558F,0x1FCC,0x53AD,{ 0x91,0x0E,0x3C,0x84,0x11,0xD4,0xD0,0x5F } }; // 7830558F-1FCC-53AD-910E-3C8411D4D05F
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Input::IInputFocusNavigationHost>{ 0x2EED4082,0x8A3A,0x52AD,{ 0xAE,0x10,0x75,0xEE,0xF5,0x11,0x78,0x9F } }; // 2EED4082-8A3A-52AD-AE10-75EEF511789F
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Input::IInputKeyboardSource3>{ 0x61696E2C,0x3F37,0x5B37,{ 0x97,0x78,0x63,0xDF,0x5F,0x81,0x51,0xF2 } }; // 61696E2C-3F37-5B37-9778-63DF5F8151F2
    ...
    template <> struct abi<winrt::Microsoft::UI::Input::IInputFocusController2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall DepartFocus(int32_t, int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Input::IInputFocusNavigationHost>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall NavigateFocus(int32_t, int32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Input::IInputKeyboardSource3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_HasFocus(bool*) noexcept = 0;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Input::FocusNavigationReason) Reason() const;
        WINRT_IMPL_AUTO(void) Reason(winrt::Microsoft::UI::Input::FocusNavigationReason const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Input::FocusNavigationResult) DepartFocus(winrt::Microsoft::UI::Input::FocusNavigationReason const& reason) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Input::FocusNavigationResult) NavigateFocus(winrt::Microsoft::UI::Input::FocusNavigationReason const& reason) const;
    ...
    template <typename D>
    struct consume_Microsoft_UI_Input_IInputKeyboardSource3
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasFocus() const;
        WINRT_IMPL_AUTO(bool) TrySetFocus() const;
        WINRT_IMPL_AUTO(winrt::event_token) GotFocus(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Input::InputKeyboardSource, winrt::Microsoft::UI::Input::InputFocusChangedEventArgs> const& handler) const;
        using GotFocus_revoker = impl::event_revoker<winrt::Microsoft::UI::Input::IInputKeyboardSource3, &impl::abi_t<winrt::Microsoft::UI::Input::IInputKeyboardSource3>::remove_GotFocus>;
        [[nodiscard]] GotFocus_revoker GotFocus(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Input::InputKeyboardSource, winrt::Microsoft::UI::Input::InputFocusChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) GotFocus(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) LostFocus(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Input::InputKeyboardSource, winrt::Microsoft::UI::Input::InputFocusChangedEventArgs> const& handler) const;
        using LostFocus_revoker = impl::event_revoker<winrt::Microsoft::UI::Input::IInputKeyboardSource3, &impl::abi_t<winrt::Microsoft::UI::Input::IInputKeyboardSource3>::remove_LostFocus>;
        [[nodiscard]] LostFocus_revoker LostFocus(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Input::InputKeyboardSource, winrt::Microsoft::UI::Input::InputFocusChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) LostFocus(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<winrt::Microsoft::UI::Input::IInputKeyboardSource3>
    {
        template <typename D> using type = consume_Microsoft_UI_Input_IInputKeyboardSource3<D>;
    };
    template <typename D>
