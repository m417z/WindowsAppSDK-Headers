...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Hosting
{
    ...
    struct __declspec(empty_bases) IWindowsXamlManagerFeature_ExperimentalApi :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IWindowsXamlManagerFeature_ExperimentalApi>
    {
        IWindowsXamlManagerFeature_ExperimentalApi(std::nullptr_t = nullptr) noexcept {}
        IWindowsXamlManagerFeature_ExperimentalApi(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct __declspec(empty_bases) IWindowsXamlManagerStaticsFeature_ExperimentalApi :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IWindowsXamlManagerStaticsFeature_ExperimentalApi>
    {
        IWindowsXamlManagerStaticsFeature_ExperimentalApi(std::nullptr_t = nullptr) noexcept {}
        IWindowsXamlManagerStaticsFeature_ExperimentalApi(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    struct __declspec(empty_bases) IXamlShutdownCompletedOnThreadEventArgs :
        winrt::Windows::Foundation::IInspectable,
