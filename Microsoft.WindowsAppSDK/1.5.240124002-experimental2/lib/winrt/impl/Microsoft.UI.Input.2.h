...
WINRT_EXPORT namespace winrt::Microsoft::UI::Input
{
    ...
    struct __declspec(empty_bases) InputKeyboardSource : winrt::Microsoft::UI::Input::IInputKeyboardSource,
        ...
        impl::require<InputKeyboardSource, winrt::Microsoft::UI::Input::IInputKeyboardSource2, winrt::Microsoft::UI::Input::IInputKeyboardSource3, winrt::Microsoft::UI::Input::IInputObject>
    {
