...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerFeature_ExperimentalApi<D>::XamlShutdownCompletedOnThread(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi)->add_XamlShutdownCompletedOnThread(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerFeature_ExperimentalApi<D>::XamlShutdownCompletedOnThread_revoker consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerFeature_ExperimentalApi<D>::XamlShutdownCompletedOnThread(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const
    {
        return impl::make_event_revoker<D, XamlShutdownCompletedOnThread_revoker>(this, XamlShutdownCompletedOnThread(handler));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerFeature_ExperimentalApi<D>::XamlShutdownCompletedOnThread(winrt::event_token const& token) const noexcept
    {
        WINRT_IMPL_SHIM(winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi)->remove_XamlShutdownCompletedOnThread(impl::bind_in(token));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerStaticsFeature_ExperimentalApi<D>::IsXamlRunningOnCurrentThread() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi)->get_IsXamlRunningOnCurrentThread(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Deferral) consume_Microsoft_UI_Xaml_Hosting_IXamlShutdownCompletedOnThreadEventArgs<D>::GetDispatcherQueueDeferral() const
    {
        void* result{};
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi> : produce_base<D, winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi>
    {
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi> : produce_base<D, winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi>
    {
        int32_t __stdcall get_IsXamlRunningOnCurrentThread(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<bool>(this->shim().IsXamlRunningOnCurrentThread());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Hosting
{
    ...
    inline auto WindowsXamlManager::IsXamlRunningOnCurrentThread()
    {
        return impl::call_factory_cast<bool(*)(IWindowsXamlManagerStaticsFeature_ExperimentalApi const&), WindowsXamlManager, IWindowsXamlManagerStaticsFeature_ExperimentalApi>([](IWindowsXamlManagerStaticsFeature_ExperimentalApi const& f) { return f.IsXamlRunningOnCurrentThread(); });
    }
...
namespace std
{
    ...
    template<> struct hash<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerFeature_ExperimentalApi> : winrt::impl::hash_base {};
    template<> struct hash<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStatics> : winrt::impl::hash_base {};
    template<> struct hash<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManagerStaticsFeature_ExperimentalApi> : winrt::impl::hash_base {};
