...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::PrivateCommon::IModelManager4>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::PrivateCommon::ImageBufferData>{ using type = struct_category<std::uint32_t, std::uint32_t, winrt::Microsoft::Windows::PrivateCommon::PixelFormat, std::uint32_t, std::uint64_t, std::uint64_t>; };
    template <> struct category<winrt::Microsoft::Windows::PrivateCommon::ImageBufferView>{ using type = struct_category<std::uint32_t, std::uint32_t, winrt::Microsoft::Windows::PrivateCommon::PixelFormat, std::uint32_t>; };
    template <> struct category<winrt::Microsoft::Windows::PrivateCommon::ImageBufferViewData>{ using type = struct_category<std::uint64_t, std::uint64_t>; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::PrivateCommon::IModelManager4> = L"Microsoft.Windows.PrivateCommon.IModelManager4";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::PrivateCommon::IModelManager4>{ 0xE7DD1800,0xFEB3,0x557D,{ 0xA2,0xEC,0x2E,0xF8,0x2E,0x34,0xC9,0x2D } }; // E7DD1800-FEB3-557D-A2EC-2EF82E34C92D
    ...
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IAnchorInstance>
    {
        ...
        {
            virtual std::int32_t __stdcall AnchorInstance(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IGetSessionHostProcessId>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetSessionHostProcessId(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IImageBufferPrivate>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetImageBufferView(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferView*) noexcept = 0;
            virtual std::int32_t __stdcall GetImageBufferViewData(std::uint32_t, struct struct_Microsoft_Windows_PrivateCommon_ImageBufferViewData*) noexcept = 0;
            virtual std::int32_t __stdcall SyncBufferWithOutValue() noexcept = 0;
            virtual std::int32_t __stdcall GetImageBufferResource(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IImageBufferResource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BufferData(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferData*) noexcept = 0;
            virtual std::int32_t __stdcall put_BufferData(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferData) noexcept = 0;
            virtual std::int32_t __stdcall Buffer(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall Width(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Height(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RowStride(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall BytesPerPixel(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall Capacity(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall PixelFormat(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IImageBufferResourceFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferData, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateInstance2(std::uint32_t, std::uint32_t, std::int32_t, std::uint32_t, std::uint64_t, std::uint64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IModelManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall EnsureModelInitialized() noexcept = 0;
            virtual std::int32_t __stdcall GenerateCacheModel(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IModelManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetPackageFamilyName(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IModelManager3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GenerateCacheModel() noexcept = 0;
            virtual std::int32_t __stdcall SetCorrelationVector(void*) noexcept = 0;
            virtual std::int32_t __stdcall IsModelCacheReady(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::IModelManager4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestGracefulShutdown() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::PrivateCommon::INotifyExpiredSessionHost>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall NotifyExpiredSessionHost(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Microsoft_Windows_PrivateCommon_IImageBufferPrivate
    {
        ...
        auto GetImageBufferViewData(std::uint32_t targetProcessId) const;
    ...
    struct consume_Microsoft_Windows_PrivateCommon_IImageBufferResourceFactory
    {
        ...
        auto CreateInstance2(std::uint32_t height, std::uint32_t width, winrt::Microsoft::Windows::PrivateCommon::PixelFormat const& pixelFormat, std::uint32_t rowStride, std::uint64_t targetProcessHandle, std::uint64_t sourceProcessHandle) const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_Windows_PrivateCommon_IModelManager4
    {
        auto RequestGracefulShutdown() const;
    };
    template <> struct consume<winrt::Microsoft::Windows::PrivateCommon::IModelManager4>
    {
        template <typename D> using type = consume_Microsoft_Windows_PrivateCommon_IModelManager4<D>;
    };
    template <typename D>
