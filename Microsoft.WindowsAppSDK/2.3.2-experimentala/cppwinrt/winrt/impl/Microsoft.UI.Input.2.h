...
WINRT_EXPORT namespace winrt::Microsoft::UI::Input
{
    ...
    struct WINRT_IMPL_EMPTY_BASES InputFocusController : winrt::Microsoft::UI::Input::IInputFocusController,
        ...
        impl::require<InputFocusController, winrt::Microsoft::UI::Input::IInputFocusController2, winrt::Microsoft::UI::Input::IInputFocusController3, winrt::Microsoft::UI::Input::IInputObject>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES InputUnderlyingWindowController : winrt::Microsoft::UI::Input::IInputUnderlyingWindowController,
        impl::base<InputUnderlyingWindowController, winrt::Microsoft::UI::Input::InputObject>,
        impl::require<InputUnderlyingWindowController, winrt::Microsoft::UI::Input::IInputObject>
    {
        InputUnderlyingWindowController(std::nullptr_t) noexcept {}
        InputUnderlyingWindowController(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::UI::Input::IInputUnderlyingWindowController(ptr, take_ownership_from_abi) {}
        static auto GetForIsland(winrt::Microsoft::UI::Content::ContentIsland const& island);
    };
