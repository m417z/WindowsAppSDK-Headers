...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::ImagingInternal
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IFaceDetectorSession :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IFaceDetectorSession>,
        impl::require<winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession, winrt::Windows::Foundation::IClosable>
    {
        IFaceDetectorSession(std::nullptr_t = nullptr) noexcept {}
        IFaceDetectorSession(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
