...
{
    enum class DetectedLineStyle : std::int32_t
    {
        Handwritten = 0,
        Other = 1,
    };
    enum class OrientationDetectionOptions : std::int32_t
    {
        None = 0,
        DetectOrientation = 1,
    };
    enum class RecognizedTableCellKindInternal : std::int32_t
    {
        Content = 0,
        RowHeader = 1,
        ColumnHeader = 2,
    ...
    struct IScreenRegionDetectorSession5;
    struct ITextRecognizerSession;
    struct ITextRecognizerSession2;
    struct ITextRecognizerSession3;
    struct ITextRecognizerSession4;
    struct ITextRecognizerSession5;
    struct ITextRecognizerSession6;
    struct ITextRecognizerSession7;
    struct BoundingBox;
    struct LineInternal;
...
{
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession5>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession4>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession5>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession7>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellKindInternal>{ using type = enum_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::LineInternal>{ using type = struct_category<winrt::Microsoft::Windows::VisionInternal::BoundingBox, winrt::Microsoft::Windows::VisionInternal::RecognizedLineStyle, std::uint32_t>; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellInternal>{ using type = struct_category<std::int32_t, std::int32_t, std::int32_t, std::int32_t, hstring, winrt::Microsoft::Windows::VisionInternal::BoundingBox, winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellKindInternal>; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::RecognizedTableInternal>{ using type = struct_category<std::int32_t, std::int32_t, winrt::Microsoft::Windows::VisionInternal::BoundingBox, std::uint32_t>; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::RecognizedTextInternal>{ using type = struct_category<float, std::uint32_t>; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::ScreenRegionBoundingBox>{ using type = struct_category<std::uint32_t, std::uint32_t, std::uint32_t, std::uint32_t>; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::TableRecognizerOptionsInternal>{ using type = struct_category<std::uint32_t, bool>; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::TextRecognizerOptionsInternal>{ using type = struct_category<winrt::Microsoft::Windows::VisionInternal::OrientationDetectionOptions, winrt::Windows::Graphics::SizeInt32, std::uint32_t>; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellKindInternal> = L"Microsoft.Windows.VisionInternal.RecognizedTableCellKindInternal";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellInternal> = L"Microsoft.Windows.VisionInternal.RecognizedTableCellInternal";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::RecognizedTableInternal> = L"Microsoft.Windows.VisionInternal.RecognizedTableInternal";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::TableRecognizerOptionsInternal> = L"Microsoft.Windows.VisionInternal.TableRecognizerOptionsInternal";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal> = L"Microsoft.Windows.VisionInternal.IRecognizedTablesInternal";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession5> = L"Microsoft.Windows.VisionInternal.IScreenRegionDetectorSession5";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession4> = L"Microsoft.Windows.VisionInternal.ITextRecognizerSession4";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession5> = L"Microsoft.Windows.VisionInternal.ITextRecognizerSession5";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6> = L"Microsoft.Windows.VisionInternal.ITextRecognizerSession6";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession7> = L"Microsoft.Windows.VisionInternal.ITextRecognizerSession7";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>{ 0xA7B3C9D1,0xE5F2,0x4A8B,{ 0x9C,0x6D,0x1E,0x2F,0x3A,0x4B,0x5C,0x6D } }; // A7B3C9D1-E5F2-4A8B-9C6D-1E2F3A4B5C6D
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession5>{ 0xC091855A,0x60AA,0x59AB,{ 0xA8,0x09,0xA8,0xBE,0x1C,0x7C,0x90,0x6E } }; // C091855A-60AA-59AB-A809-A8BE1C7C906E
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession4>{ 0xB22A3EE1,0x441D,0x5822,{ 0x8D,0x5D,0xC8,0xBD,0x96,0xD8,0xC6,0x2F } }; // B22A3EE1-441D-5822-8D5D-C8BD96D8C62F
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession5>{ 0xC1EE6DFF,0x7A93,0x57CE,{ 0x9A,0x71,0x54,0xF3,0x45,0x5A,0xA5,0xF4 } }; // C1EE6DFF-7A93-57CE-9A71-54F3455AA5F4
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>{ 0xB8C4D0E2,0xF6A3,0x5B9C,{ 0x0D,0x7E,0x2F,0x3A,0x4B,0x5C,0x6D,0x7E } }; // B8C4D0E2-F6A3-5B9C-0D7E-2F3A4B5C6D7E
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession7>{ 0xCA84E2F4,0xDB16,0x5321,{ 0x84,0x0C,0x15,0x15,0x13,0x7C,0x2B,0xAD } }; // CA84E2F4-DB16-5321-840C-1515137C2BAD
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetTables(std::uint32_t* __resultSize, struct struct_Microsoft_Windows_VisionInternal_RecognizedTableInternal**) noexcept = 0;
            virtual std::int32_t __stdcall GetTableCells(std::uint32_t, std::uint32_t* __resultSize, struct struct_Microsoft_Windows_VisionInternal_RecognizedTableCellInternal**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IRecognizedTextInternal>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDataLength(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetData(std::uint32_t, std::uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetScreenRegionsAsync(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferView, struct struct_Microsoft_Windows_PrivateCommon_ImageBufferViewData, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetScreenRegionsAsync(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferView, struct struct_Microsoft_Windows_PrivateCommon_ImageBufferViewData, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetScreenRegions(void*, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetScreenRegions4(void*, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetScreenRegions4(void*, std::uint32_t, std::uint32_t, winrt::guid, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTextFromImageAsync(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferView, struct struct_Microsoft_Windows_PrivateCommon_ImageBufferViewData, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTextFromImageAsync(struct struct_Microsoft_Windows_PrivateCommon_ImageBufferView, struct struct_Microsoft_Windows_PrivateCommon_ImageBufferViewData, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTextFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, std::uint32_t, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTextFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, std::uint32_t, std::uint32_t, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTextFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, std::uint32_t, std::uint32_t, bool, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTableFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TableRecognizerOptionsInternal, std::uint32_t, winrt::Windows::Foundation::Rect*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession7>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RecognizeTextFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, std::uint32_t, std::uint32_t, bool, void*, winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall RecognizeTableFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TableRecognizerOptionsInternal, std::uint32_t, winrt::Windows::Foundation::Rect*, winrt::guid, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_IRecognizedTablesInternal
    {
        auto GetTables() const;
        auto GetTableCells(std::uint32_t tableIndex) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>
    {
        template <typename D> using type = consume_Microsoft_Windows_VisionInternal_IRecognizedTablesInternal<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_IRecognizedTextInternal
    {
        auto GetDataLength() const;
        auto GetData(array_view<std::uint8_t> buffer) const;
    };
    ...
    {
        auto GetScreenRegionsAsync(winrt::Microsoft::Windows::PrivateCommon::ImageBufferView const& inputImageBufferView, winrt::Microsoft::Windows::PrivateCommon::ImageBufferViewData const& inputImageBufferViewData, std::uint32_t priority, std::uint32_t frequency) const;
    };
    ...
    {
        auto GetScreenRegions(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferResource, std::uint32_t priority, std::uint32_t frequency) const;
    };
    ...
    {
        auto GetScreenRegions4(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferResource, std::uint32_t priority, std::uint32_t frequency) const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_IScreenRegionDetectorSession5
    {
        auto GetScreenRegions4(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferResource, std::uint32_t priority, std::uint32_t frequency, winrt::guid const& activityId) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::VisionInternal::IScreenRegionDetectorSession5>
    {
        template <typename D> using type = consume_Microsoft_Windows_VisionInternal_IScreenRegionDetectorSession5<D>;
    };
    template <typename D>
    ...
    {
        auto RecognizeTextFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TextRecognizerOptionsInternal const& options, std::uint32_t priority, std::uint32_t frequency) const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession4
    {
        auto RecognizeTextFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TextRecognizerOptionsInternal const& options, std::uint32_t priority, std::uint32_t frequency, bool enableWordLevelConfidence) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession4>
    {
        template <typename D> using type = consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession4<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession5
    {
        auto RecognizeTextFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TextRecognizerOptionsInternal const& options, std::uint32_t priority, std::uint32_t frequency, bool enableWordLevelConfidence, param::hstring const& detectorOutputGeometryMode) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession5>
    {
        template <typename D> using type = consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession5<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession6
    {
        auto RecognizeTableFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TableRecognizerOptionsInternal const& options, array_view<winrt::Windows::Foundation::Rect const> tableRegions) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>
    {
        template <typename D> using type = consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession6<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession7
    {
        auto RecognizeTextFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TextRecognizerOptionsInternal const& options, std::uint32_t priority, std::uint32_t frequency, bool enableWordLevelConfidence, param::hstring const& detectorOutputGeometryMode, winrt::guid const& activityId) const;
        auto RecognizeTableFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TableRecognizerOptionsInternal const& options, array_view<winrt::Windows::Foundation::Rect const> tableRegions, winrt::guid const& activityId) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession7>
    {
        template <typename D> using type = consume_Microsoft_Windows_VisionInternal_ITextRecognizerSession7<D>;
    };
    ...
    struct struct_Microsoft_Windows_VisionInternal_LineInternal
    {
        ...
        struct{ float Confidence; std::int32_t Name; } Style;
    ...
    struct struct_Microsoft_Windows_VisionInternal_RecognizedTableCellInternal
    {
    ...
    template <> struct abi<Microsoft::Windows::VisionInternal::RecognizedTableCellInternal>
    {
        using type = struct_Microsoft_Windows_VisionInternal_RecognizedTableCellInternal;
    };
    struct struct_Microsoft_Windows_VisionInternal_RecognizedTableInternal
    {
    ...
    template <> struct abi<Microsoft::Windows::VisionInternal::RecognizedTableInternal>
    {
        using type = struct_Microsoft_Windows_VisionInternal_RecognizedTableInternal;
    };
    ...
    {
        struct{ std::uint32_t Left; std::uint32_t Top; std::uint32_t Right; std::uint32_t Bottom; } BoundingBox;
        std::int32_t Label;
        float Score;
    };
    ...
    struct struct_Microsoft_Windows_VisionInternal_TableRecognizerOptionsInternal
    {
        std::uint32_t TableRegionCount;
        bool PopulateCellContent;
    };
    template <> struct abi<Microsoft::Windows::VisionInternal::TableRecognizerOptionsInternal>
    {
        using type = struct_Microsoft_Windows_VisionInternal_TableRecognizerOptionsInternal;
    };
    struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal
    {
        std::int32_t OrientationDetection;
        struct{ std::int32_t Width; std::int32_t Height; } MaxAnalysisSize;
