...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManager2<D>::XamlShutdownCompletedOnThread(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const
    {
        winrt::event_token token{};
    ...
    template <typename D> typename consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManager2<D>::XamlShutdownCompletedOnThread_revoker consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManager2<D>::XamlShutdownCompletedOnThread(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager, winrt::Microsoft::UI::Xaml::Hosting::XamlShutdownCompletedOnThreadEventArgs> const& handler) const
    {
        return impl::make_event_revoker<D, XamlShutdownCompletedOnThread_revoker>(this, XamlShutdownCompletedOnThread(handler));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManager2<D>::XamlShutdownCompletedOnThread(winrt::event_token const& token) const noexcept
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Hosting::WindowsXamlManager) consume_Microsoft_UI_Xaml_Hosting_IWindowsXamlManagerStatics2<D>::GetForCurrentThread() const
    {
        void* result{};
