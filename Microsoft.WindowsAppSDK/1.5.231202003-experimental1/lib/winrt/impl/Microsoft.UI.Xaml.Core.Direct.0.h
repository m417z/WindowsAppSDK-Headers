...
#pragma once
#ifndef WINRT_Microsoft_UI_Xaml_Core_Direct_0_H
#define WINRT_Microsoft_UI_Xaml_Core_Direct_0_H
...
{
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectStatics>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::XamlDirect>{ using type = class_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::XamlEventIndex>{ using type = enum_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex>{ using type = enum_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Core::Direct::XamlTypeIndex>{ using type = enum_category; };
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::XamlDirect> = L"Microsoft.UI.Xaml.Core.Direct.XamlDirect";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::XamlEventIndex> = L"Microsoft.UI.Xaml.Core.Direct.XamlEventIndex";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex> = L"Microsoft.UI.Xaml.Core.Direct.XamlPropertyIndex";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::XamlTypeIndex> = L"Microsoft.UI.Xaml.Core.Direct.XamlTypeIndex";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect> = L"Microsoft.UI.Xaml.Core.Direct.IXamlDirect";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject> = L"Microsoft.UI.Xaml.Core.Direct.IXamlDirectObject";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectStatics> = L"Microsoft.UI.Xaml.Core.Direct.IXamlDirectStatics";
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect>{ 0x44B58E13,0x87E1,0x5843,{ 0xAC,0x21,0xC5,0x1D,0x63,0x21,0xC7,0xFB } }; // 44B58E13-87E1-5843-AC21-C51D6321C7FB
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject>{ 0xF94D4EA9,0xE795,0x4425,{ 0xA8,0xC8,0x49,0x89,0x90,0xFC,0xE9,0xC7 } }; // F94D4EA9-E795-4425-A8C8-498990FCE9C7
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectStatics>{ 0xD43D0831,0x1CC6,0x5D08,{ 0x8D,0x2C,0x20,0xFC,0x33,0x8E,0x85,0x45 } }; // D43D0831-1CC6-5D08-8D2C-20FC338E8545
    template <> struct default_interface<winrt::Microsoft::UI::Xaml::Core::Direct::XamlDirect>{ using type = winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect; };
    template <> struct abi<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall SetCornerRadiusProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_CornerRadius) noexcept = 0;
            virtual int32_t __stdcall SetDurationProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Duration) noexcept = 0;
            virtual int32_t __stdcall SetGridLengthProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_GridLength) noexcept = 0;
            virtual int32_t __stdcall SetThicknessProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Thickness) noexcept = 0;
            virtual int32_t __stdcall SetMatrixProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Media_Matrix) noexcept = 0;
            virtual int32_t __stdcall SetMatrix3DProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D) noexcept = 0;
            ...
            virtual int32_t __stdcall GetCornerRadiusProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_CornerRadius*) noexcept = 0;
            virtual int32_t __stdcall GetDurationProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Duration*) noexcept = 0;
            virtual int32_t __stdcall GetGridLengthProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_GridLength*) noexcept = 0;
            virtual int32_t __stdcall GetThicknessProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Thickness*) noexcept = 0;
            virtual int32_t __stdcall GetMatrixProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Media_Matrix*) noexcept = 0;
            virtual int32_t __stdcall GetMatrix3DProperty(void*, int32_t, struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectStatics>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) GetObject(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject) GetXamlDirectObject(winrt::Windows::Foundation::IInspectable const& object) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject) CreateInstance(winrt::Microsoft::UI::Xaml::Core::Direct::XamlTypeIndex const& typeIndex) const;
        WINRT_IMPL_AUTO(void) SetObjectProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::Foundation::IInspectable const& value) const;
        WINRT_IMPL_AUTO(void) SetXamlDirectObjectProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(void) SetBooleanProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, bool value) const;
        WINRT_IMPL_AUTO(void) SetDoubleProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, double value) const;
        WINRT_IMPL_AUTO(void) SetInt32Property(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, int32_t value) const;
        WINRT_IMPL_AUTO(void) SetStringProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, param::hstring const& value) const;
        WINRT_IMPL_AUTO(void) SetDateTimeProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::Foundation::DateTime const& value) const;
        WINRT_IMPL_AUTO(void) SetPointProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::Foundation::Point const& value) const;
        WINRT_IMPL_AUTO(void) SetRectProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::Foundation::Rect const& value) const;
        WINRT_IMPL_AUTO(void) SetSizeProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::Foundation::Size const& value) const;
        WINRT_IMPL_AUTO(void) SetTimeSpanProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::Foundation::TimeSpan const& value) const;
        WINRT_IMPL_AUTO(void) SetColorProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Windows::UI::Color const& value) const;
        WINRT_IMPL_AUTO(void) SetCornerRadiusProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::CornerRadius const& value) const;
        WINRT_IMPL_AUTO(void) SetDurationProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::Duration const& value) const;
        WINRT_IMPL_AUTO(void) SetGridLengthProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::GridLength const& value) const;
        WINRT_IMPL_AUTO(void) SetThicknessProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::Thickness const& value) const;
        WINRT_IMPL_AUTO(void) SetMatrixProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::Media::Matrix const& value) const;
        WINRT_IMPL_AUTO(void) SetMatrix3DProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D const& value) const;
        WINRT_IMPL_AUTO(void) SetEnumProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex, uint32_t value) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) GetObjectProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject) GetXamlDirectObjectProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(bool) GetBooleanProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(double) GetDoubleProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(int32_t) GetInt32Property(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(hstring) GetStringProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::DateTime) GetDateTimeProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Point) GetPointProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) GetRectProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Size) GetSizeProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::TimeSpan) GetTimeSpanProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Color) GetColorProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::CornerRadius) GetCornerRadiusProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Duration) GetDurationProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::GridLength) GetGridLengthProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Thickness) GetThicknessProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Matrix) GetMatrixProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Media::Media3D::Matrix3D) GetMatrix3DProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(uint32_t) GetEnumProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(void) ClearProperty(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlPropertyIndex const& propertyIndex) const;
        WINRT_IMPL_AUTO(uint32_t) GetCollectionCount(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject) const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject) GetXamlDirectObjectFromCollectionAt(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, uint32_t index) const;
        WINRT_IMPL_AUTO(void) AddToCollection(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(void) InsertIntoCollectionAt(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, uint32_t index, winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(bool) RemoveFromCollection(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& value) const;
        WINRT_IMPL_AUTO(void) RemoveFromCollectionAt(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, uint32_t index) const;
        WINRT_IMPL_AUTO(void) ClearCollection(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject) const;
        WINRT_IMPL_AUTO(void) AddEventHandler(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlEventIndex const& eventIndex, winrt::Windows::Foundation::IInspectable const& handler) const;
        WINRT_IMPL_AUTO(void) AddEventHandler(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlEventIndex const& eventIndex, winrt::Windows::Foundation::IInspectable const& handler, bool handledEventsToo) const;
        WINRT_IMPL_AUTO(void) RemoveEventHandler(winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject const& xamlDirectObject, winrt::Microsoft::UI::Xaml::Core::Direct::XamlEventIndex const& eventIndex, winrt::Windows::Foundation::IInspectable const& handler) const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirect>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Core_Direct_IXamlDirect<D>;
    };
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Core_Direct_IXamlDirectObject
    {
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectObject>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Core_Direct_IXamlDirectObject<D>;
    };
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Core_Direct_IXamlDirectStatics
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Core::Direct::XamlDirect) GetDefault() const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Core::Direct::IXamlDirectStatics>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Core_Direct_IXamlDirectStatics<D>;
    };
}
#endif
