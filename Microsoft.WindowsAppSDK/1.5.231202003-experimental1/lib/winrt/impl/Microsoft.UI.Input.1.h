...
WINRT_EXPORT namespace winrt::Microsoft::UI::Input
{
    ...
    struct __declspec(empty_bases) IInputKeyboardSource3 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IInputKeyboardSource3>
    {
        IInputKeyboardSource3(std::nullptr_t = nullptr) noexcept {}
        IInputKeyboardSource3(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
