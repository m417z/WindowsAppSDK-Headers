...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    ...
    struct __declspec(empty_bases) ContentIsland : winrt::Microsoft::UI::Content::IContentIsland,
        impl::require<ContentIsland, winrt::Microsoft::UI::Content::IContentIsland2, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Composition::ICompositionSupportsSystemBackdrop, winrt::Microsoft::UI::Content::IContentIslandEndpointConnectionPrivate>
    {
