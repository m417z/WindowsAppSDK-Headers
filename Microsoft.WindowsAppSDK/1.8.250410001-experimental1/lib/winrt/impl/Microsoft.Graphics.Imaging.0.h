...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Graphics::Imaging::IImageObjectRemover>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Graphics::Imaging::IImageObjectRemoverStatics>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Graphics::Imaging::ImageObjectRemover>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::Imaging::ImageObjectRemover> = L"Microsoft.Graphics.Imaging.ImageObjectRemover";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::Imaging::IImageObjectRemover> = L"Microsoft.Graphics.Imaging.IImageObjectRemover";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::Imaging::IImageObjectRemoverStatics> = L"Microsoft.Graphics.Imaging.IImageObjectRemoverStatics";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::Imaging::ImageObjectRemoverContract> = L"Microsoft.Graphics.Imaging.ImageObjectRemoverContract";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Graphics::Imaging::IImageObjectExtractorStatics>{ 0xD33E1BDE,0xFC42,0x53D6,{ 0x82,0xFF,0x7A,0xDA,0x45,0xC9,0x31,0x9A } }; // D33E1BDE-FC42-53D6-82FF-7ADA45C9319A
    template <> inline constexpr guid guid_v<winrt::Microsoft::Graphics::Imaging::IImageObjectRemover>{ 0xBF25B5F9,0xD8B0,0x5159,{ 0x9E,0x93,0x81,0xAD,0xB0,0xB2,0x8A,0xEA } }; // BF25B5F9-D8B0-5159-9E93-81ADB0B28AEA
    template <> inline constexpr guid guid_v<winrt::Microsoft::Graphics::Imaging::IImageObjectRemoverStatics>{ 0xDD4A80B1,0x032A,0x58F3,{ 0x9A,0x4D,0x5C,0x31,0x7A,0x87,0x4A,0x03 } }; // DD4A80B1-032A-58F3-9A4D-5C317A874A03
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Graphics::Imaging::IImageScalerStatics>{ 0x026772DF,0x1415,0x5F7A,{ 0xBD,0x62,0x73,0xEE,0xC0,0x8E,0xFF,0xE6 } }; // 026772DF-1415-5F7A-BD62-73EEC08EFFE6
    ...
    template <> struct default_interface<winrt::Microsoft::Graphics::Imaging::ImageObjectRemover>{ using type = winrt::Microsoft::Graphics::Imaging::IImageObjectRemover; };
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Imaging::IImageObjectRemover>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Imaging::IImageObjectRemoverStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall GetReadyState(int32_t*) noexcept = 0;
    ...
    template <typename D>
    struct consume_Microsoft_Graphics_Imaging_IImageObjectRemover
    {
    ...
    template <> struct consume<winrt::Microsoft::Graphics::Imaging::IImageObjectRemover>
    {
        template <typename D> using type = consume_Microsoft_Graphics_Imaging_IImageObjectRemover<D>;
    };
    template <typename D>
    struct consume_Microsoft_Graphics_Imaging_IImageObjectRemoverStatics
    {
        auto GetReadyState() const;
        auto EnsureReadyAsync() const;
        auto CreateAsync() const;
    };
    template <> struct consume<winrt::Microsoft::Graphics::Imaging::IImageObjectRemoverStatics>
    {
        template <typename D> using type = consume_Microsoft_Graphics_Imaging_IImageObjectRemoverStatics<D>;
    };
    template <typename D>
