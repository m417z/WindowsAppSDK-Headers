...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Markup
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IXamlPredicate :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IXamlPredicate>
    {
        IXamlPredicate(std::nullptr_t = nullptr) noexcept {}
        IXamlPredicate(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
