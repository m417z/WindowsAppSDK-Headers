...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Markup::IXamlPredicate>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Markup::IXamlPredicate> = L"Microsoft.UI.Xaml.Markup.IXamlPredicate";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Markup::IXamlPredicate>{ 0xBC1F569F,0xBC6B,0x5668,{ 0x94,0x09,0x0A,0x70,0x33,0x43,0x59,0x48 } }; // BC1F569F-BC6B-5668-9409-0A7033435948
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Markup::IXamlPredicate>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall Evaluate(void*, bool*) noexcept = 0;
        };
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Markup_IXamlPredicate
    {
        auto Evaluate(param::vector_view<hstring> const& arguments) const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Markup::IXamlPredicate>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Markup_IXamlPredicate<D>;
    };
    template <typename D>
