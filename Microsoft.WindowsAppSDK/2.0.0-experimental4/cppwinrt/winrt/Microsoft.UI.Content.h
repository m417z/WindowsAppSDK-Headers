...
namespace winrt::impl
{
    ...
    {
        bool value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Content::IChildSiteLink2>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::UI::Content::IChildSiteLink2, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Content::IChildSiteLink2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IsBelowContent(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Content::IChildSiteLink2>**)this;
            check_hresult(_winrt_abi_type->get_IsBelowContent(&value));
        }
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IChildSiteLink2<D>::IsBelowContent(bool value) const
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Content::IChildSiteLink2>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Content::IChildSiteLink2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->put_IsBelowContent(value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Content::IChildSiteLink2>**)this;
    ...
    {
        int32_t __stdcall get_IsBelowContent(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall put_IsBelowContent(bool value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
