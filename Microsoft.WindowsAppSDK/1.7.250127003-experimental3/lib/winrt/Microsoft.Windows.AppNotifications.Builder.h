...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationBuilder2)->AddCameraPreview(&result));
        return winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationBuilder{ result, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationButton2)->SetSettingStyle(static_cast<int32_t>(value), &result));
        return winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationButton{ result, take_ownership_from_abi };
    }
