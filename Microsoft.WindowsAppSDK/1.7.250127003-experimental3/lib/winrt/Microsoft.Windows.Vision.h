...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Windows_Vision_ITextRecognizer2<D>::RecognizeTextFromImageAsync(winrt::Microsoft::Graphics::Imaging::ImageBuffer const& imageBuffer, winrt::Microsoft::Windows::Vision::TextRecognizerOptions const& options, winrt::Microsoft::Windows::Workloads::WorkloadPriority const& priority) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Vision::ITextRecognizer2)->RecognizeTextFromImageAsync(*(void**)(&imageBuffer), *(void**)(&options), static_cast<int32_t>(priority), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::Windows::Vision::RecognizedText>{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Microsoft_Windows_Vision_ITextRecognizer2<D>::RecognizeTextFromImage(winrt::Microsoft::Graphics::Imaging::ImageBuffer const& imageBuffer, winrt::Microsoft::Windows::Vision::TextRecognizerOptions const& options, winrt::Microsoft::Windows::Workloads::WorkloadPriority const& priority) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Vision::ITextRecognizer2)->RecognizeTextFromImage(*(void**)(&imageBuffer), *(void**)(&options), static_cast<int32_t>(priority), &result));
        return winrt::Microsoft::Windows::Vision::RecognizedText{ result, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Microsoft_Windows_Vision_ITextRecognizerStatics<D>::IsAvailable() const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Vision::ITextRecognizerStatics)->IsAvailable(&result));
        return result;
    }
    template <typename D> auto consume_Microsoft_Windows_Vision_ITextRecognizerStatics<D>::MakeAvailableAsync() const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Windows::Vision::ITextRecognizerStatics)->MakeAvailableAsync(&operation));
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Microsoft::Windows::Vision::ITextRecognizer2> : produce_base<D, winrt::Microsoft::Windows::Vision::ITextRecognizer2>
    {
        int32_t __stdcall RecognizeTextFromImageAsync(void* imageBuffer, void* options, int32_t priority, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall RecognizeTextFromImage(void* imageBuffer, void* options, int32_t priority, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
...
{
    inline auto TextRecognizer::IsAvailable()
    {
        return impl::call_factory_cast<bool(*)(ITextRecognizerStatics const&), TextRecognizer, ITextRecognizerStatics>([](ITextRecognizerStatics const& f) { return f.IsAvailable(); });
    }
    inline auto TextRecognizer::MakeAvailableAsync()
    {
        return impl::call_factory_cast<winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Microsoft::Windows::Management::Deployment::PackageDeploymentResult, winrt::Microsoft::Windows::Management::Deployment::PackageDeploymentProgress>(*)(ITextRecognizerStatics const&), TextRecognizer, ITextRecognizerStatics>([](ITextRecognizerStatics const& f) { return f.MakeAvailableAsync(); });
    }
...
namespace std
{
    ...
    template<> struct hash<winrt::Microsoft::Windows::Vision::ITextRecognizer2> : winrt::impl::hash_base {};
