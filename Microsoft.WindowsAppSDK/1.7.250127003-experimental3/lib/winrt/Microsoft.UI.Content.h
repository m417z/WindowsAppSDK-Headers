...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentIsland2<D>::ProcessKeyboardInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentIsland2)->get_ProcessKeyboardInput(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentIsland2<D>::ProcessPointerInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentIsland2)->get_ProcessPointerInput(&value));
        return value;
    }
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentSite2<D>::ProcessKeyboardInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSite2)->get_ProcessKeyboardInput(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSite2<D>::ProcessKeyboardInput(bool value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSite2)->put_ProcessKeyboardInput(value));
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSite2<D>::ProcessPointerInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSite2)->get_ProcessPointerInput(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSite2<D>::ProcessPointerInput(bool value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSite2)->put_ProcessPointerInput(value));
    }
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteInput<D>::ProcessKeyboardInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSiteInput)->get_ProcessKeyboardInput(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteInput<D>::ProcessKeyboardInput(bool value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSiteInput)->put_ProcessKeyboardInput(value));
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteInput<D>::ProcessPointerInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSiteInput)->get_ProcessPointerInput(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteInput<D>::ProcessPointerInput(bool value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSiteInput)->put_ProcessPointerInput(value));
    }
    ...
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteView2<D>::ProcessKeyboardInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSiteView2)->get_ProcessKeyboardInput(&value));
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Content_IContentSiteView2<D>::ProcessPointerInput() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::UI::Content::IContentSiteView2)->get_ProcessPointerInput(&value));
        return value;
    }
    ...
    struct produce<D, winrt::Microsoft::UI::Content::IContentIsland2> : produce_base<D, winrt::Microsoft::UI::Content::IContentIsland2>
    {
        ...
        int32_t __stdcall get_ProcessKeyboardInput(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<bool>(this->shim().ProcessKeyboardInput());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_ProcessPointerInput(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<bool>(this->shim().ProcessPointerInput());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Microsoft::UI::Content::IContentSite2> : produce_base<D, winrt::Microsoft::UI::Content::IContentSite2>
    {
        ...
        int32_t __stdcall put_ProcessKeyboardInput(bool value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().ProcessKeyboardInput(value);
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_ProcessPointerInput(bool* value) noexcept final try
        ...
        int32_t __stdcall put_ProcessPointerInput(bool value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().ProcessPointerInput(value);
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
