...
WINRT_EXPORT namespace winrt::Microsoft::UI::Windowing
{
    ...
    enum class PlacementPersistenceBehaviorFlags : int32_t
    {
        None = 0,
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Windowing::PlacementPersistenceBehaviorFlags>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Windowing::PlacementPersistenceBehaviorFlags> = L"Microsoft.UI.Windowing.PlacementPersistenceBehaviorFlags";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Windowing::IAppWindow4>{ 0x49D01719,0x4CBA,0x57DE,{ 0x9F,0xA2,0xD5,0x2B,0x2E,0x95,0x5D,0x28 } }; // 49D01719-4CBA-57DE-9FA2-D52B2E955D28
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Windowing::IOverlappedPresenter3>{ 0xFF7841F0,0x8253,0x5ADF,{ 0xAB,0xBA,0x57,0x91,0x9B,0xFE,0x1C,0xAC } }; // FF7841F0-8253-5ADF-ABBA-57919BFE1CAC
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindow4>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall EnablePlacementPersistence(winrt::guid, bool, struct struct_Microsoft_UI_WindowId, int32_t) noexcept = 0;
            virtual int32_t __stdcall EnablePlacementPersistenceForWindowType(winrt::guid, bool, struct struct_Microsoft_UI_WindowId, int32_t, void*) noexcept = 0;
            virtual int32_t __stdcall GetCurrentPlacement(void**) noexcept = 0;
            virtual int32_t __stdcall SaveCurrentPlacement(bool*) noexcept = 0;
            virtual int32_t __stdcall SetPlacement(void*, bool, struct struct_Microsoft_UI_WindowId, int32_t, bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IOverlappedPresenter3>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall get_PreferredMaximumSize(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
            virtual int32_t __stdcall put_PreferredMaximumSize(struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
            virtual int32_t __stdcall get_PreferredMinimumSize(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
            virtual int32_t __stdcall put_PreferredMinimumSize(struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
            virtual int32_t __stdcall SetPreferredBounds(struct struct_Windows_Graphics_SizeInt32, struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
        };
    };
    ...
    {
        auto EnablePlacementPersistence(winrt::guid const& appPlacementStorageGuid, bool isMainWindow, winrt::Microsoft::UI::WindowId const& launchTargetWindowId, winrt::Microsoft::UI::Windowing::PlacementPersistenceBehaviorFlags const& flags) const;
        auto EnablePlacementPersistence(winrt::guid const& appPlacementStorageGuid, bool isMainWindow, winrt::Microsoft::UI::WindowId const& launchTargetWindowId, winrt::Microsoft::UI::Windowing::PlacementPersistenceBehaviorFlags const& flags, param::hstring const& windowType) const;
        auto GetCurrentPlacement() const;
        auto SaveCurrentPlacement() const;
        auto SetPlacement(param::hstring const& placementString, bool isFirstWindow, winrt::Microsoft::UI::WindowId const& launchTargetWindowId, winrt::Microsoft::UI::Windowing::PlacementPersistenceBehaviorFlags const& flags) const;
    ...
    {
        [[nodiscard]] auto PreferredMaximumSize() const;
        auto PreferredMaximumSize(winrt::Windows::Graphics::SizeInt32 const& value) const;
        [[nodiscard]] auto PreferredMinimumSize() const;
        auto PreferredMinimumSize(winrt::Windows::Graphics::SizeInt32 const& value) const;
        auto SetPreferredBounds(winrt::Windows::Graphics::SizeInt32 const& preferredMinimumSize, winrt::Windows::Graphics::SizeInt32 const& preferredMaximumSize) const;
    };
