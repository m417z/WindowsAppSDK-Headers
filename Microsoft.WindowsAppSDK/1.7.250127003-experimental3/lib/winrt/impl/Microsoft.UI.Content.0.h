...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentIsland2>{ 0xCEC929B3,0xEC56,0x50B9,{ 0x92,0xA8,0x5C,0x40,0xD3,0x8A,0x6F,0xC0 } }; // CEC929B3-EC56-50B9-92A8-5C40D38A6FC0
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSite2>{ 0xCD445C0D,0x3421,0x59C6,{ 0xA9,0xCF,0xA8,0x32,0xF7,0xCD,0xE5,0x27 } }; // CD445C0D-3421-59C6-A9CF-A832F7CDE527
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSiteInput>{ 0x3B4A322F,0x5B6C,0x5CD6,{ 0x85,0x5D,0x8A,0x34,0x66,0x68,0x80,0x5A } }; // 3B4A322F-5B6C-5CD6-855D-8A346668805A
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSiteView2>{ 0xD5B1D3A5,0x8EF4,0x5C7F,{ 0x87,0xBD,0xA0,0x92,0xBE,0x6D,0x42,0xE5 } }; // D5B1D3A5-8EF4-5C7F-87BD-A092BE6D42E5
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IContentIsland2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall get_ProcessKeyboardInput(bool*) noexcept = 0;
            virtual int32_t __stdcall get_ProcessPointerInput(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IContentSite2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall put_LocalToParentTransformMatrix(winrt::Windows::Foundation::Numerics::float4x4) noexcept = 0;
            virtual int32_t __stdcall get_ProcessKeyboardInput(bool*) noexcept = 0;
            virtual int32_t __stdcall put_ProcessKeyboardInput(bool) noexcept = 0;
            virtual int32_t __stdcall get_ProcessPointerInput(bool*) noexcept = 0;
            virtual int32_t __stdcall put_ProcessPointerInput(bool) noexcept = 0;
        };
    };
    ...
    struct consume_Microsoft_UI_Content_IContentIsland2
    {
        ...
        [[nodiscard]] auto ProcessKeyboardInput() const;
        [[nodiscard]] auto ProcessPointerInput() const;
    };
    ...
    struct consume_Microsoft_UI_Content_IContentSite2
    {
        ...
        auto LocalToParentTransformMatrix(winrt::Windows::Foundation::Numerics::float4x4 const& value) const;
        [[nodiscard]] auto ProcessKeyboardInput() const;
        auto ProcessKeyboardInput(bool value) const;
        [[nodiscard]] auto ProcessPointerInput() const;
        auto ProcessPointerInput(bool value) const;
    };
