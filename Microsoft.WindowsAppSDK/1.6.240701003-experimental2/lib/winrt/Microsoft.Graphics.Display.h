...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Point>) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::RawDpi() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->get_RawDpi(&value));
        return winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Point>{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(double) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::RawPixelsPerViewPixel() const
    {
        double value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->get_RawPixelsPerViewPixel(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::DpiChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Graphics::Display::DisplayInformation, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->add_DpiChanged(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::DpiChanged_revoker consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::DpiChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Graphics::Display::DisplayInformation, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        return impl::make_event_revoker<D, DpiChanged_revoker>(this, DpiChanged(handler));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::DpiChanged(winrt::event_token const& token) const noexcept
    {
        WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->remove_DpiChanged(impl::bind_in(token));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Microsoft::Graphics::Display::DisplayOrientation) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::AngularOffsetFromNativeOrientation() const
    {
        winrt::Microsoft::Graphics::Display::DisplayOrientation value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->get_AngularOffsetFromNativeOrientation(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::OrientationChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Graphics::Display::DisplayInformation, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->add_OrientationChanged(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::OrientationChanged_revoker consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::OrientationChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::Graphics::Display::DisplayInformation, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        return impl::make_event_revoker<D, OrientationChanged_revoker>(this, OrientationChanged(handler));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Microsoft_Graphics_Display_IDisplayInformation2<D>::OrientationChanged(winrt::event_token const& token) const noexcept
    {
        WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Display::IDisplayInformation2)->remove_OrientationChanged(impl::bind_in(token));
    }
