...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    struct __declspec(empty_bases) ChildContentLink : winrt::Microsoft::UI::Content::IChildContentLink,
        impl::require<ChildContentLink, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Content::IContentLink, winrt::Microsoft::UI::Content::IContentSiteBridge, winrt::Microsoft::UI::Content::IContentSiteBridge2, winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>
    {
    ...
    struct __declspec(empty_bases) ContentSiteAutomationProviderRequestedEventArgs : winrt::Microsoft::UI::Content::IContentSiteAutomationProviderRequestedEventArgs
    {
