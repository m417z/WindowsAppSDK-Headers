...
{
    enum class AutomationOptions : int32_t
    {
        Disabled = 0,
        Framework = 1,
    ...
    struct IContentIslandEnvironment3;
    ...
    struct IContentSiteBridgeAutomation;
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Content::IContentIslandEnvironment3>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::UI::Content::AutomationOptions>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Content::AutomationOptions> = L"Microsoft.UI.Content.AutomationOptions";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Content::IContentIslandEnvironment3> = L"Microsoft.UI.Content.IContentIslandEnvironment3";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation> = L"Microsoft.UI.Content.IContentSiteBridgeAutomation";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IChildContentLink>{ 0x76553855,0x4409,0x5559,{ 0xB0,0xCD,0x9C,0x51,0x16,0x59,0x79,0x35 } }; // 76553855-4409-5559-B0CD-9C5116597935
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentIslandAutomation>{ 0xA56B1A98,0x3018,0x5679,{ 0x94,0x57,0x1E,0xFF,0x8F,0x12,0xD5,0x56 } }; // A56B1A98-3018-5679-9457-1EFF8F12D556
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentIslandEnvironment3>{ 0x75C7FF43,0x5870,0x59CD,{ 0x8C,0x85,0x50,0xB7,0x61,0xA2,0x23,0xA9 } }; // 75C7FF43-5870-59CD-8C85-50B761A223A9
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentIslandStatics2>{ 0x2A109CD2,0x3665,0x5868,{ 0x89,0x03,0x29,0xA3,0x55,0xFD,0x42,0x29 } }; // 2A109CD2-3665-5868-8903-29A355FD4229
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSite3>{ 0x37F018E4,0x6282,0x5D14,{ 0x8B,0xE9,0xD6,0x2D,0x17,0x6B,0x0F,0x36 } }; // 37F018E4-6282-5D14-8BE9-D62D176B0F36
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>{ 0xECDCCFB7,0x6490,0x5A79,{ 0x93,0x79,0x14,0xF3,0x48,0xA9,0x8D,0x68 } }; // ECDCCFB7-6490-5A79-9379-14F348A98D68
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IReadOnlyDesktopSiteBridge>{ 0xB57D1B1F,0x36F0,0x5D56,{ 0x80,0xC5,0x2C,0x02,0xD2,0x5E,0xD1,0xED } }; // B57D1B1F-36F0-5D56-80C5-2C02D25ED1ED
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IChildContentLink>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall SetIsInputPassThrough(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IContentIslandEnvironment3>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IContentIslandStatics2>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall CreateSystemContentIsland(void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_AutomationOption(int32_t*) noexcept = 0;
    ...
    struct consume_Microsoft_UI_Content_IChildContentLink
    {
        ...
        WINRT_IMPL_AUTO(void) SetIsInputPassThrough(bool value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) FragmentRootAutomationProvider() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) NextSiblingAutomationProvider() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) ParentAutomationProvider() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) PreviousSiblingAutomationProvider() const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Content_IContentIslandEnvironment3
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Content::AutomationOptions) AutomationOption() const;
    };
    template <> struct consume<winrt::Microsoft::UI::Content::IContentIslandEnvironment3>
    {
        template <typename D> using type = consume_Microsoft_UI_Content_IContentIslandEnvironment3<D>;
    };
    template <typename D>
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Content::ContentIsland) Create(winrt::Microsoft::UI::Composition::Compositor const& compositor, winrt::Windows::UI::Composition::Visual const& root) const;
    ...
    template <typename D>
    struct consume_Microsoft_UI_Content_IContentSiteBridgeAutomation
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Content::AutomationOptions) AutomationOption() const;
        WINRT_IMPL_AUTO(void) AutomationOption(winrt::Microsoft::UI::Content::AutomationOptions const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IInspectable) AutomationProvider() const;
        WINRT_IMPL_AUTO(winrt::event_token) FragmentRootAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        using FragmentRootAutomationProviderRequested_revoker = impl::event_revoker<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, &impl::abi_t<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>::remove_FragmentRootAutomationProviderRequested>;
        [[nodiscard]] FragmentRootAutomationProviderRequested_revoker FragmentRootAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) FragmentRootAutomationProviderRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) NextSiblingAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        using NextSiblingAutomationProviderRequested_revoker = impl::event_revoker<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, &impl::abi_t<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>::remove_NextSiblingAutomationProviderRequested>;
        [[nodiscard]] NextSiblingAutomationProviderRequested_revoker NextSiblingAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) NextSiblingAutomationProviderRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) ParentAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        using ParentAutomationProviderRequested_revoker = impl::event_revoker<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, &impl::abi_t<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>::remove_ParentAutomationProviderRequested>;
        [[nodiscard]] ParentAutomationProviderRequested_revoker ParentAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ParentAutomationProviderRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) PreviousSiblingAutomationProviderRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        using PreviousSiblingAutomationProviderRequested_revoker = impl::event_revoker<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, &impl::abi_t<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>::remove_PreviousSiblingAutomationProviderRequested>;
        [[nodiscard]] PreviousSiblingAutomationProviderRequested_revoker PreviousSiblingAutomationProviderRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation, winrt::Microsoft::UI::Content::ContentSiteAutomationProviderRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) PreviousSiblingAutomationProviderRequested(winrt::event_token const& token) const noexcept;
    };
    template <> struct consume<winrt::Microsoft::UI::Content::IContentSiteBridgeAutomation>
    {
        template <typename D> using type = consume_Microsoft_UI_Content_IContentSiteBridgeAutomation<D>;
    };
    template <typename D>
