...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Windowing::IAppWindow4>{ 0x50432047,0x323E,0x50FF,{ 0x86,0x17,0xB3,0xCD,0xE7,0xED,0x71,0x92 } }; // 50432047-323E-50FF-8617-B3CDE7ED7192
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindow4>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_DefaultTitleBarShouldMatchAppModeTheme(bool*) noexcept = 0;
            virtual int32_t __stdcall put_DefaultTitleBarShouldMatchAppModeTheme(bool) noexcept = 0;
        };
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) DefaultTitleBarShouldMatchAppModeTheme() const;
        WINRT_IMPL_AUTO(void) DefaultTitleBarShouldMatchAppModeTheme(bool value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::DisplayId) GetMetricsFromWindowId(winrt::Microsoft::UI::WindowId const& windowId) const;
    };
