...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FeedProviderDefinitionId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) CustomQueryParameters() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::Widgets::Feeds::Providers::CustomQueryParametersUpdateOptions) CreateInstance(param::hstring const& feedProviderDefinitionId, param::hstring const& customQueryParameters) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OnAnnouncementInvoked(winrt::Microsoft::Windows::Widgets::Notifications::FeedAnnouncementInvokedArgs const& args) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(com_array<winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedProviderInfo>) GetEnabledFeedProviders() const;
        WINRT_IMPL_AUTO(void) SetCustomQueryParameters(winrt::Microsoft::Windows::Widgets::Feeds::Providers::CustomQueryParametersUpdateOptions const& options) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) SendMessageToContent(param::hstring const& feedProviderDefinitionId, param::hstring const& feedDefinitionId, param::hstring const& message) const;
        WINRT_IMPL_AUTO(void) TryShowAnnouncement(param::hstring const& feedProviderDefinitionId, param::hstring const& feedDefinitionId, winrt::Microsoft::Windows::Widgets::Notifications::FeedAnnouncement const& announcement) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) TryRemoveAnnouncementById(param::hstring const& feedProviderDefinitionId, param::hstring const& feedDefinitionId, param::hstring const& announcementId) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedManager) GetDefault() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OnFeedProviderEnabled(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedProviderEnabledArgs const& args) const;
        WINRT_IMPL_AUTO(void) OnFeedProviderDisabled(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedProviderDisabledArgs const& args) const;
        WINRT_IMPL_AUTO(void) OnFeedEnabled(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedEnabledArgs const& args) const;
        WINRT_IMPL_AUTO(void) OnFeedDisabled(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedDisabledArgs const& args) const;
        WINRT_IMPL_AUTO(void) OnCustomQueryParametersRequested(winrt::Microsoft::Windows::Widgets::Feeds::Providers::CustomQueryParametersRequestedArgs const& args) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OnAnalyticsInfoReported(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedAnalyticsInfoReportedArgs const& args) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OnErrorInfoReported(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedErrorInfoReportedArgs const& args) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FeedProviderDefinitionId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<hstring>) EnabledFeedDefinitionIds() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OnMessageReceived(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedMessageReceivedArgs const& args) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) OnResourceRequested(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedResourceRequestedArgs const& args) const;
    };
    ...
    struct consume_Microsoft_Windows_Widgets_Feeds_Providers_IFeedResourceRequest
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::StringMap) Headers() const;
        WINRT_IMPL_AUTO(void) Headers(winrt::Windows::Foundation::Collections::StringMap const& value) const;
    };
    ...
    struct consume_Microsoft_Windows_Widgets_Feeds_Providers_IFeedResourceRequestedArgs
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FeedProviderDefinitionId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FeedDefinitionId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedResourceRequest) Request() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedResourceResponse) Response() const;
        WINRT_IMPL_AUTO(void) Response(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedResourceResponse const& value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Streams::IRandomAccessStreamReference) Content() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, hstring>>) Headers() const;
        WINRT_IMPL_AUTO(void) Headers(param::async_iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, hstring>> const& value) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::Windows::Widgets::Feeds::Providers::FeedResourceResponse) CreateInstance(winrt::Windows::Storage::Streams::IRandomAccessStreamReference const& content, param::hstring const& reasonPhrase, int32_t statusCode) const;
    };
