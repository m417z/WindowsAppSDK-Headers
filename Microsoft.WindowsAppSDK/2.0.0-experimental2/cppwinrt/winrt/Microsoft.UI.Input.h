...
namespace winrt::impl
{
    ...
    {
        winrt::Microsoft::UI::WindowId value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::UI::Input::IInputUnderlyingWindowController, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_WindowId(put_abi(value)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>**)this;
            check_hresult(_winrt_abi_type->get_WindowId(put_abi(value)));
        }
        return value;
    }
    template <typename D> auto consume_Microsoft_UI_Input_IInputUnderlyingWindowController<D>::OverrideUnderlyingWindow(winrt::Microsoft::UI::WindowId const& windowId) const
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->OverrideUnderlyingWindow(impl::bind_in(windowId)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>**)this;
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Input::IInputUnderlyingWindowControllerStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::UI::Input::IInputUnderlyingWindowControllerStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputUnderlyingWindowControllerStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetForIsland(*(void**)(&island), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputUnderlyingWindowControllerStatics>**)this;
            check_hresult(_winrt_abi_type->GetForIsland(*(void**)(&island), &result));
        }
    ...
    struct produce<D, winrt::Microsoft::UI::Input::IInputUnderlyingWindowController> : produce_base<D, winrt::Microsoft::UI::Input::IInputUnderlyingWindowController>
    {
        ...
        int32_t __stdcall OverrideUnderlyingWindow(struct struct_Microsoft_UI_WindowId windowId) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
