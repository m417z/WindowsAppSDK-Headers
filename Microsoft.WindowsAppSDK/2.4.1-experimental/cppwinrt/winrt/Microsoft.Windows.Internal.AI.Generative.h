...
{
    inline HCFLanguageModelSession::HCFLanguageModelSession() :
        HCFLanguageModelSession(impl::call_factory_cast<HCFLanguageModelSession(*)(winrt::Windows::Foundation::IActivationFactory const&), HCFLanguageModelSession>([](winrt::Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<HCFLanguageModelSession>(); }))
    {
    }
...
namespace std
{
    ...
    template<> struct hash<winrt::Microsoft::Windows::Internal::AI::Generative::HCFLanguageModelSession> : winrt::impl::hash_base {};
