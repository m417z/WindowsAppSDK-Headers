...
WINRT_EXPORT namespace winrt::Microsoft::Windows::PrivateCommon
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IModelManager4 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IModelManager4>,
        impl::require<winrt::Microsoft::Windows::PrivateCommon::IModelManager4, winrt::Microsoft::Windows::PrivateCommon::IModelManager, winrt::Microsoft::Windows::PrivateCommon::IModelManager2, winrt::Microsoft::Windows::PrivateCommon::IModelManager3>
    {
        IModelManager4(std::nullptr_t = nullptr) noexcept {}
        IModelManager4(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        using impl::consume_t<IModelManager4, winrt::Microsoft::Windows::PrivateCommon::IModelManager>::GenerateCacheModel;
        using impl::consume_t<IModelManager4, winrt::Microsoft::Windows::PrivateCommon::IModelManager3>::GenerateCacheModel;
    };
