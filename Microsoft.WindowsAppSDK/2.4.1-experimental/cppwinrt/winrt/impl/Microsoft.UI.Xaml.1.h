...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml
{
    ...
    struct WINRT_IMPL_EMPTY_BASES ISetterStatics2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ISetterStatics2>
    {
        ISetterStatics2(std::nullptr_t = nullptr) noexcept {}
        ISetterStatics2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES IWindowFeature_ExperimentalApi :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IWindowFeature_ExperimentalApi>
    {
        IWindowFeature_ExperimentalApi(std::nullptr_t = nullptr) noexcept {}
        IWindowFeature_ExperimentalApi(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
