...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Graphics::ImagingInternal::ImageObjectRemover::IImageObjectRemoverSession>
    {
        ...
        {
            virtual std::int32_t __stdcall Process(void*, void*, void*, std::uint32_t, std::uint32_t) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Graphics_ImagingInternal_ImageObjectRemover_IImageObjectRemoverSession
    {
        auto Process(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferResource, winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferMaskResource, winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& outputImageBufferResource, std::uint32_t priority, std::uint32_t frequency) const;
    };
