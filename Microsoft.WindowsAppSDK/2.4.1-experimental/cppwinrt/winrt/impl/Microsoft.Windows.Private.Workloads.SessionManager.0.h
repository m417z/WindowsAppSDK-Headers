...
{
    struct IPackageSetRegistrationScope;
    struct ISessionManager;
    struct ISessionManager2;
    struct ISessionManager3;
    struct ISessionManager4;
    struct ISessionManagerStatics;
    struct PackageSetRegistrationScope;
    struct SessionManager;
    struct SessionManagerContract;
}
WINRT_EXPORT namespace winrt::impl
{
    template <> struct category<winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager4>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::Private::Workloads::SessionManager::PackageSetRegistrationScope>{ using type = class_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::Private::Workloads::SessionManager::PackageSetRegistrationScope> = L"Microsoft.Windows.Private.Workloads.SessionManager.PackageSetRegistrationScope";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope> = L"Microsoft.Windows.Private.Workloads.SessionManager.IPackageSetRegistrationScope";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager4> = L"Microsoft.Windows.Private.Workloads.SessionManager.ISessionManager4";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope>{ 0x6C316517,0x91DF,0x560F,{ 0xBF,0x4E,0x52,0x54,0xA9,0x2B,0x51,0xFE } }; // 6C316517-91DF-560F-BF4E-5254A92B51FE
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager4>{ 0x0EEBA06F,0xA74B,0x504D,{ 0xA1,0xC2,0xE0,0xC7,0x32,0x8F,0x78,0x8F } }; // 0EEBA06F-A74B-504D-A1C2-E0C7328F788F
    ...
    template <> struct default_interface<winrt::Microsoft::Windows::Private::Workloads::SessionManager::PackageSetRegistrationScope>{ using type = winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PackageSetId(void**) noexcept = 0;
            virtual std::int32_t __stdcall ActivateAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetOrCreateSessionAsync(void*, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReportSessionFailure(void*, std::int32_t, void*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetOrCreateUninitializedSessionAsync(void*, void*, std::uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall BeginPackageSetRegistrationAsync(void*, std::uint32_t, void**, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetOrCreateAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_Private_Workloads_SessionManager_IPackageSetRegistrationScope
    {
        [[nodiscard]] auto PackageSetId() const;
        auto ActivateAsync() const;
    };
    template <> struct consume<winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope>
    {
        template <typename D> using type = consume_Microsoft_Windows_Private_Workloads_SessionManager_IPackageSetRegistrationScope<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_Private_Workloads_SessionManager_ISessionManager
    {
        auto GetOrCreateSessionAsync(param::hstring const& packageName, param::hstring const& typeName, std::uint32_t priority) const;
    };
    ...
    {
        auto ReportSessionFailure(winrt::Windows::Foundation::IInspectable const& session, std::int32_t hrFailure, param::hstring const& failureMessage) const;
    };
    ...
    {
        auto GetOrCreateUninitializedSessionAsync(param::hstring const& packageName, param::hstring const& typeName, std::uint32_t priority) const;
    };
    ...
    template <typename D>
    struct consume_Microsoft_Windows_Private_Workloads_SessionManager_ISessionManager4
    {
        auto BeginPackageSetRegistrationAsync(param::hstring const& packageSetId, array_view<hstring const> packageFamilyNames) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager4>
    {
        template <typename D> using type = consume_Microsoft_Windows_Private_Workloads_SessionManager_ISessionManager4<D>;
    };
    template <typename D>
