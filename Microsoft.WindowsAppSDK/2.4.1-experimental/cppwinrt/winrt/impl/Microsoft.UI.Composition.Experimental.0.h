...
{
    enum class ExpExpressionNotificationProperty : std::int32_t
    {
        Undefined = 0,
        Clip = 1,
        Offset = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Composition::Experimental::IExpCompositionPropertyChanged>
    {
        ...
        {
            virtual std::int32_t __stdcall SetPropertyChangedListener(std::int32_t, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Composition::Experimental::IExpCompositionPropertyChangedListener>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall NotifyBooleanPropertyChanged(void*, std::int32_t, bool) noexcept = 0;
            virtual std::int32_t __stdcall NotifyColorPropertyChanged(void*, std::int32_t, struct struct_Windows_UI_Color) noexcept = 0;
            virtual std::int32_t __stdcall NotifyMatrix3x2PropertyChanged(void*, std::int32_t, winrt::Windows::Foundation::Numerics::float3x2) noexcept = 0;
            virtual std::int32_t __stdcall NotifyMatrix4x4PropertyChanged(void*, std::int32_t, winrt::Windows::Foundation::Numerics::float4x4) noexcept = 0;
            virtual std::int32_t __stdcall NotifyReferencePropertyChanged(void*, std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall NotifySinglePropertyChanged(void*, std::int32_t, float) noexcept = 0;
            virtual std::int32_t __stdcall NotifyVector2PropertyChanged(void*, std::int32_t, winrt::Windows::Foundation::Numerics::float2) noexcept = 0;
            virtual std::int32_t __stdcall NotifyVector3PropertyChanged(void*, std::int32_t, winrt::Windows::Foundation::Numerics::float3) noexcept = 0;
            virtual std::int32_t __stdcall NotifyVector4PropertyChanged(void*, std::int32_t, winrt::Windows::Foundation::Numerics::float4) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Composition::Experimental::IExpCompositionVisualSurfaceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateVisualSurfaceWithRealizationSize(void*, struct struct_Windows_Graphics_SizeInt32, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Composition::Experimental::IExpCompositor>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OpenSharedManipulationTransformFromHandle(std::uint64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Composition::Experimental::IExpVisual>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetInteraction(void*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto OpenSharedManipulationTransformFromHandle(std::uint64_t handle) const;
    };
