...
{
    enum class AppWindowPresenterKind : std::int32_t
    {
        Default = 0,
        CompactOverlay = 1,
        FullScreen = 2,
    ...
    enum class CompactOverlaySize : std::int32_t
    {
        Small = 0,
        Medium = 1,
        Large = 2,
    };
    enum class DisplayAreaFallback : std::int32_t
    {
        None = 0,
        Primary = 1,
        Nearest = 2,
    };
    enum class DisplayAreaWatcherStatus : std::int32_t
    {
        Created = 0,
        Started = 1,
    ...
    enum class IconShowOptions : std::int32_t
    {
        ShowIconAndSystemMenu = 0,
        HideIconAndSystemMenu = 1,
    };
    enum class OverlappedPresenterState : std::int32_t
    {
        Maximized = 0,
        Minimized = 1,
        Restored = 2,
    };
    enum class PlacementInfo : std::uint32_t
    {
        None = 0,
    ...
    enum class PlacementRestorationBehavior : std::uint32_t
    {
        None = 0,
    ...
    enum class TitleBarHeightOption : std::int32_t
    {
        Standard = 0,
        Tall = 1,
        Collapsed = 2,
    };
    enum class TitleBarTheme : std::int32_t
    {
        Legacy = 0,
        UseDefaultAppMode = 1,
        Light = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindow>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Id(struct struct_Microsoft_UI_WindowId*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsShownInSwitchers(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsShownInSwitchers(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsVisible(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_OwnerWindowId(struct struct_Microsoft_UI_WindowId*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall Destroy() noexcept = 0;
            virtual std::int32_t __stdcall Hide() noexcept = 0;
            virtual std::int32_t __stdcall Move(struct struct_Windows_Graphics_PointInt32) noexcept = 0;
            virtual std::int32_t __stdcall MoveAndResize(struct struct_Windows_Graphics_RectInt32) noexcept = 0;
            virtual std::int32_t __stdcall MoveAndResizeRelativeToDisplayArea(struct struct_Windows_Graphics_RectInt32, void*) noexcept = 0;
            virtual std::int32_t __stdcall Resize(struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
            virtual std::int32_t __stdcall SetIcon(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetIconWithIconId(struct struct_Microsoft_UI_IconId) noexcept = 0;
            virtual std::int32_t __stdcall SetPresenter(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetPresenterByKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall Show() noexcept = 0;
            virtual std::int32_t __stdcall ShowWithActivation(bool) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindow2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ResizeClient(struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
            virtual std::int32_t __stdcall ShowOnceWithRequestedStartupState() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindow3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AssociateWithDispatcherQueue(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindow4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetTaskbarIcon(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetTaskbarIconWithIconId(struct struct_Microsoft_UI_IconId) noexcept = 0;
            virtual std::int32_t __stdcall SetTitleBarIcon(void*) noexcept = 0;
            virtual std::int32_t __stdcall SetTitleBarIconWithIconId(struct struct_Microsoft_UI_IconId) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DidPositionChange(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_DidPresenterChange(bool*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowChangedEventArgs2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DidZOrderChange(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsZOrderAtBottom(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsZOrderAtTop(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_ZOrderBelowWindowId(struct struct_Microsoft_UI_WindowId*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowExperimental>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_PlacementRestorationBehavior(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PlacementRestorationBehavior(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall GetCurrentPlacement(void**) noexcept = 0;
            virtual std::int32_t __stdcall SaveCurrentPlacement() noexcept = 0;
            virtual std::int32_t __stdcall SetCurrentPlacement(void*, bool, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowPlacementDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_NormalRect(struct struct_Windows_Graphics_RectInt32*) noexcept = 0;
            virtual std::int32_t __stdcall get_WorkArea(struct struct_Windows_Graphics_RectInt32*) noexcept = 0;
            virtual std::int32_t __stdcall get_Dpi(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ShowCmd(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ArrangeRect(struct struct_Windows_Graphics_RectInt32*) noexcept = 0;
            virtual std::int32_t __stdcall get_DeviceName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Flags(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowPlacementDetailsStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Create(struct struct_Windows_Graphics_RectInt32, struct struct_Windows_Graphics_RectInt32, std::int32_t, std::int32_t, struct struct_Windows_Graphics_RectInt32, std::uint32_t, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithPresenter(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWithPresenterAndOwner(void*, struct struct_Microsoft_UI_WindowId, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFromWindowId(struct struct_Microsoft_UI_WindowId, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithDispatcherQueue(void*, struct struct_Microsoft_UI_WindowId, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowStatics3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SaveCurrentPlacementForAllPersistedStateIds() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowTitleBar>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IconShowOptions(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_IconShowOptions(std::int32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_LeftInset(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_RightInset(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall ResetToDefault() noexcept = 0;
            virtual std::int32_t __stdcall SetDragRectangles(std::uint32_t, struct struct_Windows_Graphics_RectInt32*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowTitleBar2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PreferredHeightOption(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferredHeightOption(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowTitleBar3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PreferredTheme(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferredTheme(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IAppWindowTitleBarStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsCustomizationSupported(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::ICompactOverlayPresenter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InitialSize(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_InitialSize(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IDisplayArea>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_OuterBounds(struct struct_Windows_Graphics_RectInt32*) noexcept = 0;
            virtual std::int32_t __stdcall get_WorkArea(struct struct_Windows_Graphics_RectInt32*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IDisplayAreaStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Primary(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateWatcher(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAll(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFromWindowId(struct struct_Microsoft_UI_WindowId, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFromPoint(struct struct_Windows_Graphics_PointInt32, std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetFromRect(struct struct_Windows_Graphics_RectInt32, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IDisplayAreaStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetFromDisplayId(struct struct_Microsoft_UI_DisplayId, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IDisplayAreaStatics3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetMetricsFromWindowId(struct struct_Microsoft_UI_WindowId, struct struct_Microsoft_UI_DisplayId*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Windowing::IOverlappedPresenter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_HasBorder(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_HasTitleBar(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsAlwaysOnTop(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsAlwaysOnTop(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsMaximizable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsMaximizable(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsMinimizable(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsMinimizable(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsModal(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsModal(bool) noexcept = 0;
            ...
            virtual std::int32_t __stdcall Maximize() noexcept = 0;
            virtual std::int32_t __stdcall Minimize() noexcept = 0;
            virtual std::int32_t __stdcall Restore() noexcept = 0;
            virtual std::int32_t __stdcall SetBorderAndTitleBar(bool, bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IOverlappedPresenter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall MinimizeWithActivation(bool) noexcept = 0;
            virtual std::int32_t __stdcall RestoreWithActivation(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IOverlappedPresenter3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PreferredMinimumHeight(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferredMinimumHeight(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredMinimumWidth(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferredMinimumWidth(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredMaximumWidth(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferredMaximumWidth(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredMaximumHeight(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PreferredMaximumHeight(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IOverlappedPresenterStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall Create(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForContextMenu(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForDialog(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForToolWindow(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Windowing::IOverlappedPresenterStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RequestedStartupState(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto Create(winrt::Windows::Graphics::RectInt32 const& normalRect, winrt::Windows::Graphics::RectInt32 const& workArea, std::int32_t dpi, std::int32_t showCmd, winrt::Windows::Graphics::RectInt32 const& arrangeRect, winrt::Microsoft::UI::Windowing::PlacementInfo const& flags, param::hstring const& deviceName) const;
    };
    ...
    struct consume_Microsoft_UI_Windowing_IOverlappedPresenter3
    {
        ...
        auto PreferredMinimumHeight(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto PreferredMinimumWidth() const;
        auto PreferredMinimumWidth(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto PreferredMaximumWidth() const;
        auto PreferredMaximumWidth(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
        [[nodiscard]] auto PreferredMaximumHeight() const;
        auto PreferredMaximumHeight(winrt::Windows::Foundation::IReference<std::int32_t> const& value) const;
    };
