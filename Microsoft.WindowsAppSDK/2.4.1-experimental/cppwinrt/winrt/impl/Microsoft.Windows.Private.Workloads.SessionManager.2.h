...
{
    struct WINRT_IMPL_EMPTY_BASES PackageSetRegistrationScope : winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope,
        impl::require<PackageSetRegistrationScope, winrt::Windows::Foundation::IClosable>
    {
        PackageSetRegistrationScope(std::nullptr_t) noexcept {}
        PackageSetRegistrationScope(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Windows::Private::Workloads::SessionManager::IPackageSetRegistrationScope(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES SessionManager : winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager,
        impl::require<SessionManager, winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager2, winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager3, winrt::Microsoft::Windows::Private::Workloads::SessionManager::ISessionManager4, winrt::Microsoft::Windows::PrivateCommon::IAnchorInstance, winrt::Microsoft::Windows::PrivateCommon::INotifyExpiredSessionHost, winrt::Windows::Foundation::IClosable>
    {
