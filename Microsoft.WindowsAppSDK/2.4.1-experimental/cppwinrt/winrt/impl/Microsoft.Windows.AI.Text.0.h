...
WINRT_EXPORT namespace winrt::Microsoft::Windows::AI::Text
{
    enum class GenerateStructuredJsonResponseStatus : std::int32_t
    {
        ...
        Error = 6,
        CompleteWithInvalidStructure = 7,
    };
    enum class InputKind : std::int32_t
    {
        GeneralConversation = 0,
        Email = 1,
    };
    enum class LanguageModelResponseStatus : std::int32_t
    {
        Complete = 0,
        InProgress = 1,
        BlockedByPolicy = 2,
        ...
        ResponseBlockedByContentModeration = 5,
        Error = 6,
        IncompatibleLowRankAdapter = 7,
        UnsupportedLanguage = 8,
        LanguageMismatch = 9,
    };
    enum class TextRewriteTone : std::int32_t
    {
        Default = 0,
        General = 1,
        Casual = 2,
    ...
    struct ILanguageModelLowRankAdapter;
    struct ILanguageModelLowRankAdapterResult;
    struct ILanguageModelLowRankAdapterStatics;
    struct ILanguageModelOptions;
    struct ILanguageModelOptions2;
    ...
    struct LanguageModelLowRankAdapterResult;
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ILanguageModel3>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::ITextRewriter3>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::GenerateStructuredJsonResponseResult>{ using type = class_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapter>{ using type = class_category; };
    template <> struct category<winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapterResult>{ using type = class_category; };
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::Text::GenerateStructuredJsonResponseStatus>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::GenerateStructuredJsonResponseResult> = L"Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseResult";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapter> = L"Microsoft.Windows.AI.Text.LanguageModelLowRankAdapter";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapterResult> = L"Microsoft.Windows.AI.Text.LanguageModelLowRankAdapterResult";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::GenerateStructuredJsonResponseStatus> = L"Microsoft.Windows.AI.Text.GenerateStructuredJsonResponseStatus";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult> = L"Microsoft.Windows.AI.Text.IGenerateStructuredJsonResponseResult";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ILanguageModel3> = L"Microsoft.Windows.AI.Text.ILanguageModel3";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter> = L"Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapter";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult> = L"Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterResult";
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics> = L"Microsoft.Windows.AI.Text.ILanguageModelLowRankAdapterStatics";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2> = L"Microsoft.Windows.AI.Text.ILanguageModelOptions2";
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::AI::Text::ITextRewriter3> = L"Microsoft.Windows.AI.Text.ITextRewriter3";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult>{ 0x1CFE5F4C,0x897A,0x5692,{ 0xB9,0xAE,0xCC,0xB5,0x4E,0xDA,0x14,0xC5 } }; // 1CFE5F4C-897A-5692-B9AE-CCB54EDA14C5
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ILanguageModel3>{ 0xE5F6B00D,0xA835,0x5170,{ 0x86,0x4C,0x4A,0xA8,0x10,0xA7,0xFD,0x15 } }; // E5F6B00D-A835-5170-864C-4AA810A7FD15
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter>{ 0xDC67C5F1,0x4A8B,0x5178,{ 0xA0,0xFD,0x54,0x88,0xFD,0x49,0xA6,0x81 } }; // DC67C5F1-4A8B-5178-A0FD-5488FD49A681
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>{ 0xB23AF149,0x70FD,0x53F1,{ 0x9E,0x5C,0x51,0xBA,0x64,0x2A,0x78,0x36 } }; // B23AF149-70FD-53F1-9E5C-51BA642A7836
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>{ 0xE3B61010,0x37C3,0x56D5,{ 0xB1,0x12,0x1A,0xA5,0x7A,0xD5,0xBF,0xC7 } }; // E3B61010-37C3-56D5-B112-1AA57AD5BFC7
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>{ 0x8FAC9616,0xA95F,0x56F7,{ 0x96,0xD8,0xE0,0x1E,0xBD,0xDA,0x1D,0x39 } }; // 8FAC9616-A95F-56F7-96D8-E01EBDDA1D39
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::AI::Text::ITextRewriter3>{ 0x622EB80A,0xED1A,0x5525,{ 0x80,0xD8,0xC6,0xE8,0x02,0x36,0xA1,0x95 } }; // 622EB80A-ED1A-5525-80D8-C6E80236A195
    ...
    template <> struct default_interface<winrt::Microsoft::Windows::AI::Text::GenerateStructuredJsonResponseResult>{ using type = winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult; };
    ...
    template <> struct default_interface<winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapter>{ using type = winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter; };
    template <> struct default_interface<winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapterResult>{ using type = winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::IConversationItem>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Participant(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::IConversationSummaryOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_InputKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_InputKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeMessageCitations(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeMessageCitations(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeParticipantAttribution(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeParticipantAttribution(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxKeyPoints(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxKeyPoints(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Language(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Language(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModel2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GenerateResponseAsync2(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateResponseAsync3(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateResponseFromEmbeddingsAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateResponseFromEmbeddingsAsync2(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateResponseFromEmbeddingsAsync3(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateEmbeddingVectors(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateEmbeddingVectors2(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetUsablePromptLength(void*, std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetUsablePromptLength2(void*, void*, std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetVectorSpaceId(winrt::guid*) noexcept = 0;
            virtual std::int32_t __stdcall CreateContext(void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateContext2(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateContext3(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModel3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GenerateStructuredJsonResponseAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GenerateStructuredJsonResponseAsync2(void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModelEmbeddingVectorResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EmbeddingVectors(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromPath(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_LowRankAdapter(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextRewriter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RewriteAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextRewriter2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RewriteAsync(void*, std::int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextRewriter3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RewriteCustomAsync(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextSummarizer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SummarizeAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SummarizeParagraphAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextSummarizer2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SummarizeConversationAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextSummarizer3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsPromptLargerThanContext(std::uint32_t, void**, void*, std::uint64_t*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsPromptLargerThanContext(void*, std::uint64_t*, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextToTableConverter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ConvertAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextToTableResponseResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetRows(std::uint32_t* __resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall get_Status(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExtendedError(winrt::hresult*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::Text::ITextToTableRow>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetColumns(std::uint32_t* __resultSize, void***) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Microsoft_Windows_AI_Text_IConversationSummaryOptions
    {
        ...
        auto MaxKeyPoints(std::uint32_t value) const;
    ...
    template <typename D>
    struct consume_Microsoft_Windows_AI_Text_IGenerateStructuredJsonResponseResult
    {
        [[nodiscard]] auto Text() const;
        [[nodiscard]] auto Status() const;
        [[nodiscard]] auto ExtendedError() const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_IGenerateStructuredJsonResponseResult<D>;
    };
    template <typename D>
    ...
    template <typename D>
    struct consume_Microsoft_Windows_AI_Text_ILanguageModel3
    {
        auto GenerateStructuredJsonResponseAsync(param::hstring const& prompt, param::hstring const& jsonSchema) const;
        auto GenerateStructuredJsonResponseAsync(param::hstring const& prompt, param::hstring const& jsonSchema, winrt::Microsoft::Windows::AI::Text::LanguageModelOptions const& options) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ILanguageModel3>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ILanguageModel3<D>;
    };
    template <typename D>
    ...
    template <typename D>
    struct consume_Microsoft_Windows_AI_Text_ILanguageModelLowRankAdapter
    {
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ILanguageModelLowRankAdapter<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AI_Text_ILanguageModelLowRankAdapterResult
    {
        [[nodiscard]] auto LowRankAdapter() const;
        [[nodiscard]] auto ExtendedError() const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ILanguageModelLowRankAdapterResult<D>;
    };
    template <typename D>
    struct consume_Microsoft_Windows_AI_Text_ILanguageModelLowRankAdapterStatics
    {
        auto CreateFromPath(param::hstring const& filePath) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ILanguageModelLowRankAdapterStatics<D>;
    };
    template <typename D>
    ...
    template <typename D>
    struct consume_Microsoft_Windows_AI_Text_ILanguageModelOptions2
    {
        [[nodiscard]] auto LowRankAdapter() const;
        auto LowRankAdapter(winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapter const& value) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ILanguageModelOptions2<D>;
    };
    template <typename D>
    ...
    {
        auto RewriteCustomAsync(param::hstring const& text, param::hstring const& customTone) const;
    };
    template <> struct consume<winrt::Microsoft::Windows::AI::Text::ITextRewriter3>
    {
        template <typename D> using type = consume_Microsoft_Windows_AI_Text_ITextRewriter3<D>;
    };
    template <typename D>
    ...
    {
        auto IsPromptLargerThanContext(array_view<winrt::Microsoft::Windows::AI::Text::ConversationItem const> messages, winrt::Microsoft::Windows::AI::Text::ConversationSummaryOptions const& options, std::uint64_t& cutoffPosition) const;
    };
    ...
    {
        auto IsPromptLargerThanContext(param::hstring const& text, std::uint64_t& cutoffPosition) const;
    };
