...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::Internal::Imaging
{
    ...
    struct ImagingInternalContract;
}
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Graphics::Internal::Imaging::ImagingInternalContract> = L"Microsoft.Graphics.Internal.Imaging.ImagingInternalContract";
