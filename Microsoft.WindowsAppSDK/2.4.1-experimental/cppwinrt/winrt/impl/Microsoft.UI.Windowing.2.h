...
WINRT_EXPORT namespace winrt::Microsoft::UI::Windowing
{
    ...
    struct WINRT_IMPL_EMPTY_BASES AppWindowPlacementDetails : winrt::Microsoft::UI::Windowing::IAppWindowPlacementDetails
    {
        ...
        static auto Create(winrt::Windows::Graphics::RectInt32 const& normalRect, winrt::Windows::Graphics::RectInt32 const& workArea, std::int32_t dpi, std::int32_t showCmd, winrt::Windows::Graphics::RectInt32 const& arrangeRect, winrt::Microsoft::UI::Windowing::PlacementInfo const& flags, param::hstring const& deviceName);
    };
