...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::IDeploymentManagerStatics3, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::IDeploymentManagerStatics3>::Repair, &result);
        return winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::DeploymentResult{ result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall Repair(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
