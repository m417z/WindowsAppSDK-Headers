...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Dispatching_IDispatcherQueue
    {
        ...
        [[nodiscard]] ShutdownStarting_revoker ShutdownStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Microsoft::UI::Dispatching::DispatcherQueueShutdownStartingEventArgs> const& handler) const;
        ...
        [[nodiscard]] ShutdownCompleted_revoker ShutdownCompleted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    struct consume_Microsoft_UI_Dispatching_IDispatcherQueue3
    {
        ...
        [[nodiscard]] FrameworkShutdownStarting_revoker FrameworkShutdownStarting(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Microsoft::UI::Dispatching::DispatcherQueueShutdownStartingEventArgs> const& handler) const;
        ...
        [[nodiscard]] FrameworkShutdownCompleted_revoker FrameworkShutdownCompleted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    struct consume_Microsoft_UI_Dispatching_IDispatcherQueueTimer
    {
        ...
        [[nodiscard]] Tick_revoker Tick(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueueTimer, winrt::Windows::Foundation::IInspectable> const& handler) const;
