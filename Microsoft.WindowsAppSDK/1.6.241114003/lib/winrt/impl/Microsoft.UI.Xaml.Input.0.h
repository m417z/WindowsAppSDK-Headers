...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Input_IFocusManagerStatics
    {
        ...
        [[nodiscard]] GotFocus_revoker GotFocus(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::FocusManagerGotFocusEventArgs> const& handler) const;
        ...
        [[nodiscard]] LostFocus_revoker LostFocus(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::FocusManagerLostFocusEventArgs> const& handler) const;
        ...
        [[nodiscard]] GettingFocus_revoker GettingFocus(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::GettingFocusEventArgs> const& handler) const;
        ...
        [[nodiscard]] LosingFocus_revoker LosingFocus(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Microsoft::UI::Xaml::Input::LosingFocusEventArgs> const& handler) const;
    ...
    struct consume_Microsoft_UI_Xaml_Input_IKeyboardAccelerator
    {
        ...
        [[nodiscard]] Invoked_revoker Invoked(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Input::KeyboardAccelerator, winrt::Microsoft::UI::Xaml::Input::KeyboardAcceleratorInvokedEventArgs> const& handler) const;
    ...
    struct consume_Microsoft_UI_Xaml_Input_IXamlUICommand
    {
        ...
        [[nodiscard]] ExecuteRequested_revoker ExecuteRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Input::XamlUICommand, winrt::Microsoft::UI::Xaml::Input::ExecuteRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] CanExecuteRequested_revoker CanExecuteRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Input::XamlUICommand, winrt::Microsoft::UI::Xaml::Input::CanExecuteRequestedEventArgs> const& handler) const;
