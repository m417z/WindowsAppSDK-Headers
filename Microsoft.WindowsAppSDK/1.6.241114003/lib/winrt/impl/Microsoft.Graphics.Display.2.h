...
{
    struct __declspec(empty_bases) DisplayAdvancedColorInfo : winrt::Microsoft::Graphics::Display::IDisplayAdvancedColorInfo
    {
    ...
    struct __declspec(empty_bases) DisplayInformation : winrt::Microsoft::Graphics::Display::IDisplayInformation,
