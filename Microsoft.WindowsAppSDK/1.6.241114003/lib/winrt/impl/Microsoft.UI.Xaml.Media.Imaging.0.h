...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Media_Imaging_IBitmapImage
    {
        ...
        [[nodiscard]] DownloadProgress_revoker DownloadProgress(auto_revoke_t, winrt::Microsoft::UI::Xaml::Media::Imaging::DownloadProgressEventHandler const& handler) const;
    ...
    struct consume_Microsoft_UI_Xaml_Media_Imaging_ISvgImageSource
    {
        ...
        [[nodiscard]] Opened_revoker Opened(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource, winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceOpenedEventArgs> const& handler) const;
        ...
        [[nodiscard]] OpenFailed_revoker OpenFailed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource, winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceFailedEventArgs> const& handler) const;
