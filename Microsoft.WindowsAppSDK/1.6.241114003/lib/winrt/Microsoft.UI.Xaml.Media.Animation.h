...
namespace winrt::impl
{
    ...
    template <typename D> typename consume_Microsoft_UI_Xaml_Media_Animation_IConnectedAnimation<D>::Completed_revoker consume_Microsoft_UI_Xaml_Media_Animation_IConnectedAnimation<D>::Completed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Xaml::Media::Animation::ConnectedAnimation, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    template <typename D> typename consume_Microsoft_UI_Xaml_Media_Animation_ITimeline<D>::Completed_revoker consume_Microsoft_UI_Xaml_Media_Animation_ITimeline<D>::Completed(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        return impl::make_event_revoker<D, Completed_revoker>(this, Completed(handler));
    }
