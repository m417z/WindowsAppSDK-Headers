...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Devices::Input::IPenDevice2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Input::IPenDevice2>::get_SimpleHapticsController, &value);
