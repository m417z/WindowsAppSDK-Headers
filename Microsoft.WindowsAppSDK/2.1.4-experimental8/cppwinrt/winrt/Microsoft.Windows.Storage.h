...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::Windows::Storage::IApplicationDataStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::Windows::Storage::IApplicationDataStatics2>::GetForUnpackaged, *(void**)(&publisher), *(void**)(&product), &result);
        return winrt::Microsoft::Windows::Storage::ApplicationData{ result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall GetForUnpackaged(void* publisher, void* product, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
