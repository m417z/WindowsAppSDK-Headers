...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::Media::Effects::IAudioEffect2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Effects::IAudioEffect2>::get_AcousticEchoCancellationConfiguration, &value);
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Media::Effects::IAudioEffect2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Effects::IAudioEffect2>::get_CanSetState, &value);
        return value;
    }
    template <typename D> auto consume_Windows_Media_Effects_IAudioEffect2<D>::State() const
    {
        ...
        consume_general<winrt::Windows::Media::Effects::IAudioEffect2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Effects::IAudioEffect2>::get_State, reinterpret_cast<std::int32_t*>(&value));
        return value;
    }
    ...
    {
        std::int32_t __stdcall get_AcousticEchoCancellationConfiguration(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall get_CanSetState(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
