...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::System::Diagnostics::ISystemDiagnosticInfoStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsArchitectureSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredArchitecture(std::int32_t*) noexcept = 0;
        };
    };
