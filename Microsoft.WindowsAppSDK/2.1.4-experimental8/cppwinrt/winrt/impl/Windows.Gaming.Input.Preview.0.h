...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetExtendedDeviceInfo(std::uint32_t* __bufferSize, std::uint8_t**) noexcept = 0;
            virtual std::int32_t __stdcall SetHeadsetOperation(std::int32_t, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetHeadsetOperation(std::int32_t, std::uint32_t* __bufferSize, std::uint8_t**) noexcept = 0;
