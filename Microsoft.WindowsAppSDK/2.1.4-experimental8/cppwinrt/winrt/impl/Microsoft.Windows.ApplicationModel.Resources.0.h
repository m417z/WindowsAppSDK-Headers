...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IKnownResourceQualifierNameStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HomeRegion(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Language(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LayoutDirection(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Scale(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_TargetSize(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Theme(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IResourceCandidate>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ValueAsBytes(std::uint32_t* __valueSize, std::uint8_t**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IResourceCandidateFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateInstance2(std::uint32_t, std::uint8_t*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IResourceLoaderStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDefaultResourceFilePath(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IResourceManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateResourceContext(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_ResourceNotFound(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ResourceNotFound(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IResourceMap>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ResourceCount(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetSubtree(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetSubtree(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetValue(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetValueWithContext(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetValueByIndex(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetValueByIndexWithContext(std::uint32_t, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetValue(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetValueWithContext(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::Resources::IResourceNotFoundEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall SetResolvedCandidate(void*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Microsoft_Windows_ApplicationModel_Resources_IResourceCandidateFactory
    {
        ...
        auto CreateInstance2(array_view<std::uint8_t const> data) const;
    };
    ...
    struct consume_Microsoft_Windows_ApplicationModel_Resources_IResourceMap
    {
        ...
        auto GetValueByIndex(std::uint32_t index) const;
        auto GetValueByIndex(std::uint32_t index, winrt::Microsoft::Windows::ApplicationModel::Resources::ResourceContext const& context) const;
