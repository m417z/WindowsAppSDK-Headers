...
WINRT_EXPORT namespace winrt::Windows::Media::Audio
{
    ...
    enum class AudioEffectsPackStatus : std::int32_t
    {
        NotEnabled = 0,
        Enabled = 1,
        NotSupported = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioEffectsPackConfiguration>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_EffectsPackId(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Media::Audio::IAudioEffectsPackConfigurationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetForDeviceId(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall IsDeviceIdSupported(void*, void*, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Audio::ISpatialAudioFormatSubtypeStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DTSXForHomeTheater(void**) noexcept = 0;
        };
    };
    template <typename D>
