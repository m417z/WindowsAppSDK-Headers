...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Media::Media3D::IMatrix3DHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Identity(struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D*) noexcept = 0;
            virtual std::int32_t __stdcall Multiply(struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D, struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D, struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D*) noexcept = 0;
            virtual std::int32_t __stdcall FromElements(double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D*) noexcept = 0;
            virtual std::int32_t __stdcall GetHasInverse(struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetIsIdentity(struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D, bool*) noexcept = 0;
            virtual std::int32_t __stdcall Invert(struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D, struct struct_Microsoft_UI_Xaml_Media_Media3D_Matrix3D*) noexcept = 0;
        };
    };
