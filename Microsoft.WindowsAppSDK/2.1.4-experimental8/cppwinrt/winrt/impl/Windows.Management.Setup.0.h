...
{
    enum class DeploymentAgentProgressState : std::int32_t
    {
        NotStarted = 0,
        Initializing = 1,
        InProgress = 2,
    ...
    enum class DeploymentSessionConnectionChange : std::int32_t
    {
        NoChange = 0,
    ...
    enum class DeploymentSessionStateChange : std::int32_t
    {
        NoChange = 0,
        CancelRequestedByUser = 1,
        RetryRequestedByUser = 2,
    };
    enum class DeploymentWorkloadState : std::int32_t
    {
        NotStarted = 0,
        InProgress = 1,
        Completed = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Management::Setup::IAgentProvisioningProgressReport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ProgressPercentage(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_ProgressPercentage(double) noexcept = 0;
            virtual std::int32_t __stdcall get_EstimatedTimeRemaining(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_EstimatedTimeRemaining(std::int64_t) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayProgress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DisplayProgress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayProgressSecondary(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DisplayProgressSecondary(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Batches(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentBatchIndex(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_CurrentBatchIndex(std::uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::Setup::IDeploymentSessionConnectionChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Change(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Management::Setup::IDeploymentWorkload>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DisplayFriendlyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DisplayFriendlyName(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall put_ErrorMessage(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PossibleCause(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PossibleCause(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PossibleResolution(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PossibleResolution(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_State(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_State(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_StateDetails(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_StateDetails(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::Setup::IDeploymentWorkloadBatch>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DisplayCategoryTitle(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DisplayCategoryTitle(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_BatchWorkloads(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::Setup::IDeploymentWorkloadBatchFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(std::uint32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Management::Setup::IMachineProvisioningProgressReporter>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SessionConnection(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_SessionState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_SessionStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionStateChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SessionConnectionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SessionConnectionChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall ReportProgress(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetDevicePreparationExecutionContextAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Management::Setup::IMachineProvisioningProgressReporterStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetForLaunchUri(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Management_Setup_IAgentProvisioningProgressReport
    {
        ...
        auto CurrentBatchIndex(std::uint32_t value) const;
    };
    ...
    {
        auto CreateInstance(std::uint32_t id) const;
    };
