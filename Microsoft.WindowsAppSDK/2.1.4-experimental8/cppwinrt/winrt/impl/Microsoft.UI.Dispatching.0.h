...
WINRT_EXPORT namespace winrt::Microsoft::UI::Dispatching
{
    ...
    enum class DispatcherRunOptions : std::uint32_t
    {
        None = 0,
        ContinueOnQuit = 0x1,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Dispatching::IDispatcherQueue3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall EnqueueEventLoopExit() noexcept = 0;
            virtual std::int32_t __stdcall EnsureSystemDispatcherQueue() noexcept = 0;
            virtual std::int32_t __stdcall RunEventLoop() noexcept = 0;
            virtual std::int32_t __stdcall RunEventLoopWithOptions(std::uint32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall add_FrameworkShutdownStarting(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_FrameworkShutdownStarting(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_FrameworkShutdownCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_FrameworkShutdownCompleted(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Dispatching::IDispatcherQueueController2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ShutdownQueue() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Dispatching::IDispatcherQueueControllerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateOnCurrentThread(void**) noexcept = 0;
        };
    };
