...
{
    enum class CatalogModelInstanceStatus : std::int32_t
    {
        Available = 0,
        InProgress = 1,
        Unavailable = 2,
    };
    enum class CatalogModelStatus : std::int32_t
    {
        Ready = 0,
        NotReady = 1,
    };
    enum class ExecutionProviderCertification : std::int32_t
    {
        Unknown = 0,
        Certified = 1,
        Uncertified = 2,
    };
    enum class ExecutionProviderReadyResultState : std::int32_t
    {
        InProgress = 0,
        Success = 1,
        Failure = 2,
    };
    enum class ExecutionProviderReadyState : std::int32_t
    {
        Ready = 0,
        NotReady = 1,
        NotPresent = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::ICatalogModelInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ExecutionProviders(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ModelSizeInBytes(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Version(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_License(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LicenseUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LicenseText(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetInstanceAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetInstanceAsync2(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::ICatalogModelInstance>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ModelPaths(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ModelInfo(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::ICatalogModelInstanceResult>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_DiagnosticText(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetInstance(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProvider>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Name(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_LibraryPath(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_PackageId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ReadyState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Certification(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall EnsureReadyAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryRegister(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FindAllProviders(std::uint32_t* __resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall EnsureAndRegisterCertifiedAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall RegisterCertifiedAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalog>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Sources(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_ExecutionProviders(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAvailableModel(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAvailableModels(void**) noexcept = 0;
            virtual std::int32_t __stdcall FindModelAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall FindAllModelsAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::MachineLearning::IModelCatalogSourceStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateFromUriAsync2(void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
