...
WINRT_EXPORT namespace winrt::Microsoft::UI::Input
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IInputFocusController3 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IInputFocusController3>
    {
        IInputFocusController3(std::nullptr_t = nullptr) noexcept {}
        IInputFocusController3(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES IInputUnderlyingWindowController :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IInputUnderlyingWindowController>
    {
        IInputUnderlyingWindowController(std::nullptr_t = nullptr) noexcept {}
        IInputUnderlyingWindowController(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES IInputUnderlyingWindowControllerStatics :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IInputUnderlyingWindowControllerStatics>
    {
        IInputUnderlyingWindowControllerStatics(std::nullptr_t = nullptr) noexcept {}
        IInputUnderlyingWindowControllerStatics(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
