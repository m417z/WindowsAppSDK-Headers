...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IChildSiteLink2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IChildSiteLink2>
    {
        IChildSiteLink2(std::nullptr_t = nullptr) noexcept {}
        IChildSiteLink2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES ICoreWindowTopLevelWindowBridge :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICoreWindowTopLevelWindowBridge>
    {
        ICoreWindowTopLevelWindowBridge(std::nullptr_t = nullptr) noexcept {}
        ICoreWindowTopLevelWindowBridge(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
