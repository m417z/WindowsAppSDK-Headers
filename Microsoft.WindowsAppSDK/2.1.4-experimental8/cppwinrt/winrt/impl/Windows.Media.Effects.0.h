...
{
    enum class AudioEffectState : std::int32_t
    {
        Off = 0,
        On = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Effects::IAcousticEchoCancellationConfiguration>
    {
        ...
        {
            virtual std::int32_t __stdcall SetEchoCancellationRenderEndpoint(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Effects::IAudioEffect2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AcousticEchoCancellationConfiguration(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CanSetState(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_State(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetState(std::int32_t) noexcept = 0;
        };
    };
