...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStoreContext5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetUserPurchaseHistoryAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAssociatedStoreProductsByInAppOfferTokenAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestPurchaseByInAppOfferTokenAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Services::Store::IStorePrice2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UnformattedBasePrice(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UnformattedPrice(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_UnformattedRecurrencePrice(void**) noexcept = 0;
        };
    };
