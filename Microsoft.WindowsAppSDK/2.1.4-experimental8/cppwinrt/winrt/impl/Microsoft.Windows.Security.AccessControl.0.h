...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::Security::AccessControl::AppContainerNameAndAccess>{ using type = struct_category<hstring, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall GetSddlForAppContainerNames(std::uint32_t, struct struct_Microsoft_Windows_Security_AccessControl_AppContainerNameAndAccess*, void*, std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetSecurityDescriptorBytesFromAppContainerNames(std::uint32_t, struct struct_Microsoft_Windows_Security_AccessControl_AppContainerNameAndAccess*, void*, std::uint32_t, std::uint32_t* __resultSize, std::uint8_t**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_Security_AccessControl_ISecurityDescriptorHelpersStatics
    {
        auto GetSddlForAppContainerNames(array_view<winrt::Microsoft::Windows::Security::AccessControl::AppContainerNameAndAccess const> accessRequests, param::hstring const& principalStringSid, std::uint32_t principalAccessMask) const;
        auto GetSecurityDescriptorBytesFromAppContainerNames(array_view<winrt::Microsoft::Windows::Security::AccessControl::AppContainerNameAndAccess const> accessRequests, param::hstring const& principalStringSid, std::uint32_t principalAccessMask) const;
    };
