...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Data::LoadMoreItemsResult>{ using type = struct_category<std::uint32_t>; };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Data::IDataErrorsChangedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_PropertyName(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Data::INotifyDataErrorInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_HasErrors(bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_ErrorsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ErrorsChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetErrors(void*, void**) noexcept = 0;
        };
    };
