...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        consume_general<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::Hide, *(void**)(&subtree));
    }
    ...
    {
        consume_general<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::ShowMemoryUsage, *(void**)(&subtree));
    }
    ...
    {
        consume_general<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::ShowOverdraw, *(void**)(&subtree), static_cast<std::uint32_t>(contentKinds));
    }
    ...
    {
        consume_general<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>::ShowRedraw, *(void**)(&subtree));
    }
    template <typename D> auto consume_Microsoft_UI_Composition_Diagnostics_ICompositionDebugSettings<D>::HeatMaps() const
    {
        void* value{};
        consume_general<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettings>::get_HeatMaps, &value);
    ...
    {
        void* result{};
        consume_general<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Microsoft::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>::TryGetSettings, *(void**)(&compositor), &result);
