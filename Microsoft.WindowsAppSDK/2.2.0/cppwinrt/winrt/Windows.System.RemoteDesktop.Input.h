...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool value{};
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>::get_IsEnabled, &value);
        return value;
    }
    ...
    {
        void* value{};
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory>::CreateInstance, impl::bind_in(connectionId), *(void**)(&pduForwarder), &value);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>::CreateInstance, impl::bind_in(connectionId), *(void**)(&pduForwarder), static_cast<std::uint32_t>(options), &value);
        return winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnection{ value, take_ownership_from_abi };
    }
    template <typename H> struct delegate<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler, H> final : implements_delegate<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler, H>
    {
        ...
        std::int32_t __stdcall Invoke(std::uint32_t __pduDataSize, std::uint8_t* pduData, bool* result) noexcept final try
        {
            *result = detach_from<bool>((*this)(array_view<std::uint8_t const>(reinterpret_cast<std::uint8_t const *>(pduData), reinterpret_cast<std::uint8_t const *>(pduData) + __pduDataSize)));
            return 0;
        }
    ...
    {
        std::int32_t __stdcall CreateInstance(winrt::guid connectionId, void* pduForwarder, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall CreateInstance(winrt::guid connectionId, void* pduForwarder, std::uint32_t options, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
