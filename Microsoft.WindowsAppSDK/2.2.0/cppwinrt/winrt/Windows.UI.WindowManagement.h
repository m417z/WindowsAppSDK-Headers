...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::UI::WindowManagement::IWindowServicesStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::WindowManagement::IWindowServicesStatics>::FindAllTopLevelWindowIds, &result);
    ...
    {
        std::int32_t __stdcall FindAllTopLevelWindowIds(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
