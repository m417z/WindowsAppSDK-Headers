...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnChannel5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AppendVpnReceivePacketBuffer(void*) noexcept = 0;
            virtual std::int32_t __stdcall AppendVpnSendPacketBuffer(void*) noexcept = 0;
            virtual std::int32_t __stdcall FlushVpnReceivePacketBuffers() noexcept = 0;
            virtual std::int32_t __stdcall FlushVpnSendPacketBuffers() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnChannel6>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ActivateForeground(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnForegroundActivatedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_ActivationOperation(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnForegroundActivationOperation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Complete(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnPlugInReconnectTransport>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall ReconnectTransport(void*, void*) noexcept = 0;
        };
    };
