...
{
    enum class BadgeNotificationGlyph : std::int32_t
    {
        None = 0,
        Activity = 1,
        Alarm = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::BadgeNotifications::IBadgeNotificationManager>
    {
        ...
        {
            virtual std::int32_t __stdcall SetBadgeAsCount(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetBadgeAsGlyph(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall ClearBadge() noexcept = 0;
        };
    };
    ...
    {
        auto SetBadgeAsCount(std::uint32_t notificationCount) const;
