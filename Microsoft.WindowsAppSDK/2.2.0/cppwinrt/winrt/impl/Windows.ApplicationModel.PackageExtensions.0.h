...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::PackageExtensions::IPackageExtension>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetExtensionProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetExtensionPropertiesAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPublicPath(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetPublicFolder(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::PackageExtensions::IPackageExtensionPackageInstalledEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PackageExtensionName(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Package(void**) noexcept = 0;
