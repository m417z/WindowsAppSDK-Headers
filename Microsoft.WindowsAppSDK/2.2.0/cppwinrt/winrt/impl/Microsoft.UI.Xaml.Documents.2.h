...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Documents
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Typography : winrt::Microsoft::UI::Xaml::Documents::ITypography
    {
        ...
        static auto SetAnnotationAlternates(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value);
        ...
        static auto SetStandardSwashes(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value);
        ...
        static auto SetContextualSwashes(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value);
        ...
        static auto SetStylisticAlternates(winrt::Microsoft::UI::Xaml::DependencyObject const& element, std::int32_t value);
