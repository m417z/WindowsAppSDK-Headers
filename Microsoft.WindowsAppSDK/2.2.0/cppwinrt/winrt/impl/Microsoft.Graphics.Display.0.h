...
{
    enum class DisplayAdvancedColorKind : std::int32_t
    {
        StandardDynamicRange = 0,
        WideColorGamut = 1,
        HighDynamicRange = 2,
    };
    enum class DisplayHdrMetadataFormat : std::int32_t
    {
        Hdr10 = 0,
        Hdr10Plus = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Display::IDisplayAdvancedColorInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_MaxLuminanceInNits(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_MinLuminanceInNits(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxAverageFullFrameLuminanceInNits(double*) noexcept = 0;
            virtual std::int32_t __stdcall get_SdrWhiteLevelInNits(double*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Display::IDisplayInformation>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_IsStereoEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_IsStereoEnabledChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsStereoEnabledChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall GetColorProfileAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetColorProfile(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Display::IDisplayInformationStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateForDisplayId(struct struct_Microsoft_UI_DisplayId, void**) noexcept = 0;
        };
    };
    template <typename D>
