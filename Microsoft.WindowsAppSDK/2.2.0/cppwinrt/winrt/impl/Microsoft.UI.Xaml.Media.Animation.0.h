...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Media::Animation::IColorKeyFrame>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_KeyTime(struct struct_Microsoft_UI_Xaml_Media_Animation_KeyTime*) noexcept = 0;
            virtual std::int32_t __stdcall put_KeyTime(struct struct_Microsoft_UI_Xaml_Media_Animation_KeyTime) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Media::Animation::IKeyTimeHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall FromTimeSpan(std::int64_t, struct struct_Microsoft_UI_Xaml_Media_Animation_KeyTime*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Media::Animation::IRepeatBehaviorHelperStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Forever(struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior*) noexcept = 0;
            virtual std::int32_t __stdcall FromCount(double, struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior*) noexcept = 0;
            virtual std::int32_t __stdcall FromDuration(std::int64_t, struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior*) noexcept = 0;
            virtual std::int32_t __stdcall GetHasCount(struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior, bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetHasDuration(struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior, bool*) noexcept = 0;
            virtual std::int32_t __stdcall Equals(struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior, struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Media::Animation::ITimeline>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Duration(struct struct_Microsoft_UI_Xaml_Duration*) noexcept = 0;
            virtual std::int32_t __stdcall put_Duration(struct struct_Microsoft_UI_Xaml_Duration) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_RepeatBehavior(struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior*) noexcept = 0;
            virtual std::int32_t __stdcall put_RepeatBehavior(struct struct_Microsoft_UI_Xaml_Media_Animation_RepeatBehavior) noexcept = 0;
            virtual std::int32_t __stdcall add_Completed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_Completed(winrt::event_token) noexcept = 0;
        };
    };
