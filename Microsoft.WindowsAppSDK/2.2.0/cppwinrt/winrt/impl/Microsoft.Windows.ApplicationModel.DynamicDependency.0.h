...
{
    enum class PackageDependencyLifetimeArtifactKind : std::int32_t
    {
        Process = 0,
        FilePath = 1,
        RegistryKey = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::PackageDependencyContextId>{ using type = struct_category<std::uint64_t>; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IAddPackageDependencyOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Rank(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_PrependIfRankCollision(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_PrependIfRankCollision(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::ICreatePackageDependencyOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Architectures(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Architectures(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_VerifyDependencyResolution(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_VerifyDependencyResolution(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_LifetimeArtifactKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_LifetimeArtifactKind(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_LifetimeArtifact(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LifetimeArtifact(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependency>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall Add2(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependencyContext>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ContextId(struct struct_Microsoft_Windows_ApplicationModel_DynamicDependency_PackageDependencyContextId*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependencyContextFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(struct struct_Microsoft_Windows_ApplicationModel_DynamicDependency_PackageDependencyContextId, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependencyRankStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Default(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependencyStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetFromIdForSystem(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall Create(void*, struct struct_Windows_ApplicationModel_PackageVersion, void**) noexcept = 0;
            virtual std::int32_t __stdcall Create2(void*, struct struct_Windows_ApplicationModel_PackageVersion, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForSystem(void*, struct struct_Windows_ApplicationModel_PackageVersion, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_GenerationId(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::ApplicationModel::DynamicDependency::IPackageDependencyStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PackageGraphRevisionId(std::uint32_t*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_ApplicationModel_DynamicDependency_IAddPackageDependencyOptions
    {
        ...
        auto Rank(std::int32_t value) const;
