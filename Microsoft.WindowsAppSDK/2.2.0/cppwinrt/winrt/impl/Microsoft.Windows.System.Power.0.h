...
WINRT_EXPORT namespace winrt::Microsoft::Windows::System::Power
{
    ...
    enum class DisplayStatus : std::int32_t
    {
        Off = 0,
        On = 1,
        Dimmed = 2,
    };
    enum class EffectivePowerMode : std::int32_t
    {
        BatterySaver = 0,
        BetterBattery = 1,
        Balanced = 2,
    ...
    enum class PowerSourceKind : std::int32_t
    {
        AC = 0,
        DC = 1,
    };
    ...
    enum class SystemSuspendStatus : std::int32_t
    {
        Uninitialized = 0,
        Entering = 1,
        AutoResume = 2,
    ...
    enum class UserPresenceStatus : std::int32_t
    {
        Present = 0,
        Absent = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::System::Power::IPowerManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_PowerSourceKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_PowerSourceKindChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PowerSourceKindChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_DisplayStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_DisplayStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_DisplayStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SystemIdleStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SystemIdleStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_EffectivePowerMode(void**) noexcept = 0;
            virtual std::int32_t __stdcall add_EffectivePowerModeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_EffectivePowerModeChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_UserPresenceStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_UserPresenceStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_UserPresenceStatusChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall get_SystemSuspendStatus(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_SystemSuspendStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SystemSuspendStatusChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::System::Power::IPowerManagerStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_EffectivePowerMode2(std::int32_t*) noexcept = 0;
        };
    };
    template <typename D>
