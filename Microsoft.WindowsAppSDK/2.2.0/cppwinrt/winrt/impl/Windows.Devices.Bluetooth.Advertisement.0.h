...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementDataTypesStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_PeripheralConnectionIntervalRange(std::uint8_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementScanParameters>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ScanWindow(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ScanInterval(std::uint16_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementScanParametersStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CoexistenceOptimized(void**) noexcept = 0;
            virtual std::int32_t __stdcall LowLatency(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::Advertisement::IBluetoothLEAdvertisementWatcher3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_UseHardwareFilter(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_UseHardwareFilter(bool) noexcept = 0;
        };
    };
