...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Markup
{
    ...
    struct IXamlBindingHelperStatics2;
    struct IXamlCondition;
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::UI::Xaml::Markup::IXamlBindingHelperStatics2>{ using type = interface_category; };
    template <> struct category<winrt::Microsoft::UI::Xaml::Markup::IXamlCondition>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Markup::IXamlBindingHelperStatics2> = L"Microsoft.UI.Xaml.Markup.IXamlBindingHelperStatics2";
    template <> inline constexpr auto& name_v<winrt::Microsoft::UI::Xaml::Markup::IXamlCondition> = L"Microsoft.UI.Xaml.Markup.IXamlCondition";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Markup::IXamlBindingHelperStatics2>{ 0xC02650DC,0x4DA5,0x5DDF,{ 0xAA,0xE2,0x84,0x45,0xE9,0x87,0xF4,0xC4 } }; // C02650DC-4DA5-5DDF-AAE2-8445E987F4C4
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Xaml::Markup::IXamlCondition>{ 0x9124118D,0xCDFA,0x545F,{ 0x8C,0x12,0x4C,0xF7,0xBC,0xC5,0xFF,0xFA } }; // 9124118D-CDFA-545F-8C12-4CF7BCC5FFFA
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Markup::IXamlBindingHelperStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetPropertyFromThickness(void*, void*, struct struct_Microsoft_UI_Xaml_Thickness) noexcept = 0;
            virtual std::int32_t __stdcall SetPropertyFromCornerRadius(void*, void*, struct struct_Microsoft_UI_Xaml_CornerRadius) noexcept = 0;
            virtual std::int32_t __stdcall SetPropertyFromColor(void*, void*, struct struct_Windows_UI_Color) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::UI::Xaml::Markup::IXamlCondition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Evaluate(void*, bool*) noexcept = 0;
        };
    };
    ...
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Markup_IXamlBindingHelperStatics2
    {
        auto SetPropertyFromThickness(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Microsoft::UI::Xaml::Thickness const& value) const;
        auto SetPropertyFromCornerRadius(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Microsoft::UI::Xaml::CornerRadius const& value) const;
        auto SetPropertyFromColor(winrt::Windows::Foundation::IInspectable const& dependencyObject, winrt::Microsoft::UI::Xaml::DependencyProperty const& propertyToSet, winrt::Windows::UI::Color const& value) const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Markup::IXamlBindingHelperStatics2>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Markup_IXamlBindingHelperStatics2<D>;
    };
    template <typename D>
    struct consume_Microsoft_UI_Xaml_Markup_IXamlCondition
    {
        auto Evaluate(param::hstring const& argument) const;
    };
    template <> struct consume<winrt::Microsoft::UI::Xaml::Markup::IXamlCondition>
    {
        template <typename D> using type = consume_Microsoft_UI_Xaml_Markup_IXamlCondition<D>;
    };
    template <typename D>
