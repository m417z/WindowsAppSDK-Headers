...
{
    enum class ActivationSignalDetectionConfigurationCreationStatus : std::int32_t
    {
        Success = 0,
    ...
    enum class ActivationSignalDetectionConfigurationRemovalResult : std::int32_t
    {
        Success = 0,
        NotFound = 1,
        CurrentlyEnabled = 2,
    ...
    enum class ActivationSignalDetectionConfigurationSetModelDataResult : std::int32_t
    {
        Success = 0,
        EmptyModelData = 1,
        UnsupportedFormat = 2,
    ...
    enum class ActivationSignalDetectionConfigurationStateChangeResult : std::int32_t
    {
        Success = 0,
        NoModelData = 1,
    ...
    enum class ConversationalAgentActivationKind : std::int32_t
    {
        VoiceActivationPreview = 0,
        Foreground = 1,
    };
    enum class ConversationalAgentActivationResult : std::int32_t
    {
        Success = 0,
        AgentInactive = 1,
    ...
    enum class ConversationalAgentVoiceActivationPrerequisiteKind : std::int32_t
    {
    ...
    enum class SignalDetectorResourceKind : std::int32_t
    {
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IActivationSignalDetectionConfiguration2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetModelDataWithResult(void*, void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetModelDataWithResultAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetEnabledWithResultAsync(bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetEnabledWithResult(bool, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_TrainingStepCompletionMaxAllowedTime(std::uint32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IActivationSignalDetector2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAvailableModelIdsForSignalIdAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAvailableModelIdsForSignalId(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateConfigurationWithResultAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateConfigurationWithResult(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveConfigurationWithResultAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveConfigurationWithResult(void*, void*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_DetectorId(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentDetectorManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetActivationSignalDetectorFromId(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall GetActivationSignalDetectorFromIdAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSession2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall RequestActivationAsync(std::int32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RequestActivation(std::int32_t, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetSupportLockScreenActivationAsync(bool, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetSupportLockScreenActivation(bool) noexcept = 0;
            virtual std::int32_t __stdcall GetMissingPrerequisites(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetMissingPrerequisitesAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSignal2>
    {
        ...
        {
            virtual std::int32_t __stdcall get_DetectorId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DetectorKind(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::ConversationalAgent::IDetectionConfigurationAvailabilityInfo2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UnavailableSystemResources(void**) noexcept = 0;
        };
    };
    template <typename D>
