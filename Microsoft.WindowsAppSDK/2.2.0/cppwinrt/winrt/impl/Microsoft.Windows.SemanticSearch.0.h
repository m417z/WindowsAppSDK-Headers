...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVector>
    {
        ...
        {
            virtual std::int32_t __stdcall GetValues(std::uint32_t, float*) noexcept = 0;
            virtual std::int32_t __stdcall get_Count(std::uint32_t*) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::SemanticSearch::IEmbeddingVectorFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(std::uint32_t, float*, winrt::guid, void**) noexcept = 0;
        };
    };
    template <typename D>
