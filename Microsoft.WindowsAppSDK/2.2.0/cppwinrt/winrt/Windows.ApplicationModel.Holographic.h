...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboardStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboardStatics>::GetDefault, &result);
