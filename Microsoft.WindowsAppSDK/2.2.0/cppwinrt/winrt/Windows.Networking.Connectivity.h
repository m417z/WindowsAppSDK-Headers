...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        bool result{};
        consume_general<winrt::Windows::Networking::Connectivity::IConnectionProfile6, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Networking::Connectivity::IConnectionProfile6>::IsDomainAuthenticatedBy, static_cast<std::int32_t>(kind), &result);
        return result;
    }
    ...
    {
        std::int32_t __stdcall IsDomainAuthenticatedBy(std::int32_t kind, bool* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
