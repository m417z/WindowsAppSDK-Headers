...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Graphics_Display_IDisplayServicesStatics<D>::FindAll() const
    {
        ...
        consume_general<winrt::Windows::Graphics::Display::IDisplayServicesStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Graphics::Display::IDisplayServicesStatics>::FindAll, &result_impl_size, &result);
    ...
    {
        std::int32_t __stdcall FindAll(std::uint32_t* __resultSize, struct struct_Windows_Graphics_DisplayId** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
