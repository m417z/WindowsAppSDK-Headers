...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* result{};
        consume_general<winrt::Windows::Storage::Streams::IPropertySetSerializer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Storage::Streams::IPropertySetSerializer>::Serialize, *(void**)(&propertySet), &result);
    ...
    {
        std::int32_t __stdcall Serialize(void* propertySet, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
