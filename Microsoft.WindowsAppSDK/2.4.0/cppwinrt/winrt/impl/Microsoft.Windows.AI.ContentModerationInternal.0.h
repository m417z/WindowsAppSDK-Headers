...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::AI::ContentModerationInternal::ImageContentAnalysisScores>{ using type = struct_category<std::uint32_t, float, float, float, float, float>; };
    template <> struct category<winrt::Microsoft::Windows::AI::ContentModerationInternal::TextContentAnalysisScores>{ using type = struct_category<std::uint32_t, std::uint32_t, std::uint32_t, std::uint32_t, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::ContentModerationInternal::IImageContentModerationSession>
    {
        ...
        {
            virtual std::int32_t __stdcall ValidateImage(void*, std::uint32_t, std::uint32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall AnalyzeImage(void*, std::uint32_t, std::uint32_t, struct struct_Microsoft_Windows_AI_ContentModerationInternal_ImageContentAnalysisScores*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::ContentModerationInternal::ITextBlockListSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsTextBlocked(void*, void*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AI::ContentModerationInternal::ITextContentModerationSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AnalyzeText(void*, std::uint32_t, std::uint32_t, struct struct_Microsoft_Windows_AI_ContentModerationInternal_TextContentAnalysisScores*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_AI_ContentModerationInternal_IImageContentModerationSession
    {
        auto ValidateImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferResource, std::uint32_t priority, std::uint32_t frequency) const;
        auto AnalyzeImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& inputImageBufferResource, std::uint32_t priority, std::uint32_t frequency) const;
    };
    ...
    {
        auto AnalyzeText(param::hstring const& text, std::uint32_t priority, std::uint32_t frequency) const;
    };
    ...
    {
        std::uint32_t numCategoryLevels;
    ...
    {
        std::uint32_t numCategoryLevels;
        std::uint32_t selfHarmContentLevel;
        std::uint32_t violentContentLevel;
        std::uint32_t hateContentLevel;
        std::uint32_t sexualContentLevel;
    };
