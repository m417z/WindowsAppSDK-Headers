...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::Internal::Imaging
{
    ...
    inline FaceDetectorSession::FaceDetectorSession() :
        FaceDetectorSession(impl::call_factory_cast<FaceDetectorSession(*)(winrt::Windows::Foundation::IActivationFactory const&), FaceDetectorSession>([](winrt::Windows::Foundation::IActivationFactory const& f) { return f.template ActivateInstance<FaceDetectorSession>(); }))
    {
    }
...
namespace std
{
    ...
    template<> struct hash<winrt::Microsoft::Graphics::Internal::Imaging::DetectFacesResult> : winrt::impl::hash_base {};
    template<> struct hash<winrt::Microsoft::Graphics::Internal::Imaging::DetectedFace> : winrt::impl::hash_base {};
    template<> struct hash<winrt::Microsoft::Graphics::Internal::Imaging::FaceDetectorSession> : winrt::impl::hash_base {};
