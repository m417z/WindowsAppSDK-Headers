...
namespace winrt::impl
{
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::GenerativeInternal::IImageDescriptionSession2>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::AI::GenerativeInternal::IImageDescriptionSession2, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::GenerativeInternal::IImageDescriptionSession2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->DescribeAsyncWithProgress(*(void**)(&imageBufferResource), static_cast<int32_t>(kind), impl::bind_in(contentFilterOptions), impl::bind_in(progressEventToken), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::GenerativeInternal::IImageDescriptionSession2>**)this;
            check_hresult(_winrt_abi_type->DescribeAsyncWithProgress(*(void**)(&imageBufferResource), static_cast<int32_t>(kind), impl::bind_in(contentFilterOptions), impl::bind_in(progressEventToken), &result));
        }
        return winrt::Microsoft::Windows::AI::GenerativeInternal::IImageDescriptionSessionResult{ result, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall DescribeAsyncWithProgress(void* imageBufferResource, int32_t kind, struct struct_Microsoft_Windows_AI_GenerativeInternal_ContentFilterOptionsInternal contentFilterOptions, winrt::guid progressEventToken, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
