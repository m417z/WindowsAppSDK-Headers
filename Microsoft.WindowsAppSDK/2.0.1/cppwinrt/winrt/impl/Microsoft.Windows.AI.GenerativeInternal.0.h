...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::AI::GenerativeInternal::IImageDescriptionSession2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall DescribeAsyncWithProgress(void*, int32_t, struct struct_Microsoft_Windows_AI_GenerativeInternal_ContentFilterOptionsInternal, winrt::guid, void**) noexcept = 0;
        };
    };
