...
namespace winrt::impl
{
    ...
    {
        bool value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Input::IInputFocusController3>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::UI::Input::IInputFocusController3, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputFocusController3>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_ShouldShowKeyboardCues(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IInputFocusController3>**)this;
            check_hresult(_winrt_abi_type->get_ShouldShowKeyboardCues(&value));
        }
        return value;
    }
    ...
    template <typename D> auto consume_Microsoft_UI_Input_IPointerPointStatics<D>::GetCurrentPoint(uint32_t pointerId) const
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::UI::Input::IPointerPointStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::UI::Input::IPointerPointStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IPointerPointStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetCurrentPoint(pointerId, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::UI::Input::IPointerPointStatics>**)this;
            check_hresult(_winrt_abi_type->GetCurrentPoint(pointerId, &result));
        }
        return winrt::Microsoft::UI::Input::PointerPoint{ result, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall get_ShouldShowKeyboardCues(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
