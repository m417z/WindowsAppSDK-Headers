...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Windows_AI_Text_ITextRewriter2<D>::RewriteAsync(param::hstring const& text, winrt::Microsoft::Windows::AI::Text::TextRewriteTone const& tone) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::Text::ITextRewriter2>)
        {
            ...
            check_hresult(_winrt_abi_type->RewriteAsync(*(void**)(&text), static_cast<int32_t>(tone), &operation));
        }
        else
        {
    ...
    {
        void* operation{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::Text::ITextRewriter3>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::AI::Text::ITextRewriter3, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ITextRewriter3>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->RewriteCustomAsync(*(void**)(&text), *(void**)(&customTone), &operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ITextRewriter3>**)this;
            check_hresult(_winrt_abi_type->RewriteCustomAsync(*(void**)(&text), *(void**)(&customTone), &operation));
        }
        return winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Microsoft::Windows::AI::Text::LanguageModelResponseResult, hstring>{ operation, take_ownership_from_abi };
    }
    ...
    {
        bool result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->IsPromptLargerThanContext(*(void**)(&text), &cutoffPosition, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ITextSummarizer4>**)this;
            check_hresult(_winrt_abi_type->IsPromptLargerThanContext(*(void**)(&text), &cutoffPosition, &result));
        }
        return result;
    }
    ...
    {
        int32_t __stdcall RewriteCustomAsync(void* text, void* customTone, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
