...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    ...
    enum class PopupAnchor : int32_t
    {
        None = 0,
        TopLevelWindow = 1,
        ParentIsland = 2,
...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::UI::Content::IChildSiteLink2>{ 0xFE40E0E9,0x1586,0x55B4,{ 0xBC,0xEA,0xA5,0xD3,0x78,0xD9,0x14,0xC0 } }; // FE40E0E9-1586-55B4-BCEA-A5D378D914C0
    ...
    template <> struct abi<winrt::Microsoft::UI::Content::IChildSiteLink2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall get_IsBelowContent(bool*) noexcept = 0;
            virtual int32_t __stdcall put_IsBelowContent(bool) noexcept = 0;
        };
    };
