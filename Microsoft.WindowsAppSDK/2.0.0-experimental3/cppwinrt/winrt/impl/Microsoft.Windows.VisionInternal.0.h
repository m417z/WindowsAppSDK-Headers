...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession4>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall RecognizeTextFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, uint32_t, uint32_t, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession5>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall RecognizeTextFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TextRecognizerOptionsInternal, uint32_t, uint32_t, bool, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto RecognizeTextFromImage(winrt::Microsoft::Windows::PrivateCommon::ImageBufferResource const& imageBufferResource, winrt::Microsoft::Windows::VisionInternal::TextRecognizerOptionsInternal const& options, uint32_t priority, uint32_t frequency, bool enableWordLevelConfidence) const;
    };
