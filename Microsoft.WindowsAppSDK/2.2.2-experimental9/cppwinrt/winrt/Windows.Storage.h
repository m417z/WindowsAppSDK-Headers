...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        std::uint64_t result{};
        consume_general<winrt::Windows::Storage::IStorageLibraryChangeReader2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Storage::IStorageLibraryChangeReader2>::GetLastChangeId, &result);
        return result;
    }
    ...
    {
        bool value{};
        consume_general<winrt::Windows::Storage::IStorageLibraryChangeTrackerOptions, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Storage::IStorageLibraryChangeTrackerOptions>::get_TrackChangeDetails, &value);
        return value;
    }
    ...
    {
        std::uint64_t value{};
        consume_general<winrt::Windows::Storage::IStorageLibraryLastChangeIdStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Storage::IStorageLibraryLastChangeIdStatics>::get_Unknown, &value);
        return value;
    }
    ...
    {
        std::int32_t __stdcall GetLastChangeId(std::uint64_t* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *result = detach_from<std::uint64_t>(this->shim().GetLastChangeId());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall get_TrackChangeDetails(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall get_Unknown(std::uint64_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<std::uint64_t>(this->shim().Unknown());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
