...
WINRT_EXPORT namespace winrt::Windows::Security::Authentication::Web::Core
{
    ...
    enum class WebAuthenticationAddAccountStatus : std::int32_t
    {
        Success = 0,
        Error = 1,
        NotSupportedByProvider = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Authentication::Web::Core::IWebAuthenticationAddAccountResponseFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWithAccount(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Security::Authentication::Web::Core::IWebAuthenticationCoreManagerStatics5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall AddAccountWithTransferTokenAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_TransferToken(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TransferToken(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Properties(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Authentication::Web::Core::IWebAuthenticationTransferTokenRequestFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateWithCorrelationId(void*, void*, void*, void**) noexcept = 0;
        };
    };
