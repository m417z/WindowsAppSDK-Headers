...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Markup
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IXamlBindingHelperStatics2 :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IXamlBindingHelperStatics2>
    {
        IXamlBindingHelperStatics2(std::nullptr_t = nullptr) noexcept {}
        IXamlBindingHelperStatics2(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES IXamlCondition :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IXamlCondition>
    {
        IXamlCondition(std::nullptr_t = nullptr) noexcept {}
        IXamlCondition(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
