...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::System::IEnvironmentManager>
    {
        ...
        {
            virtual std::int32_t __stdcall GetEnvironmentVariables(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetEnvironmentVariable(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall SetEnvironmentVariable(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall AppendToPath(void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveFromPath(void*) noexcept = 0;
            virtual std::int32_t __stdcall AddExecutableFileExtension(void*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveExecutableFileExtension(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::System::IEnvironmentManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_AreChangesTracked(bool*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::System::IEnvironmentManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetForProcess(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetForUser(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetForMachine(void**) noexcept = 0;
