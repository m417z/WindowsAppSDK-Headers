...
WINRT_EXPORT namespace winrt::Windows::AI::MachineLearning
{
    ...
    enum class LearningModelPixelRange : std::int32_t
    {
        ZeroTo255 = 0,
        ZeroToOne = 1,
        MinusOneToOne = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::AI::MachineLearning::IImageFeatureDescriptor2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_PixelRange(std::int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::AI::MachineLearning::ILearningModelSessionOptions3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OverrideNamedDimension(void*, std::uint32_t) noexcept = 0;
        };
    };
    ...
    {
        auto OverrideNamedDimension(param::hstring const& name, std::uint32_t dimension) const;
    };
