...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::Internal::Imaging
{
    ...
    struct WINRT_IMPL_EMPTY_BASES DetectFacesResult : winrt::Microsoft::Graphics::ImagingInternal::IDetectFacesResult
    {
        DetectFacesResult(std::nullptr_t) noexcept {}
        DetectFacesResult(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Graphics::ImagingInternal::IDetectFacesResult(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES DetectedFace : winrt::Microsoft::Graphics::ImagingInternal::IDetectedFace
    {
        DetectedFace(std::nullptr_t) noexcept {}
        DetectedFace(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Graphics::ImagingInternal::IDetectedFace(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES FaceDetectorSession : winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession,
        impl::require<FaceDetectorSession, winrt::Microsoft::Windows::PrivateCommon::IAnchorInstance, winrt::Microsoft::Windows::PrivateCommon::IGetSessionHostProcessId>
    {
        FaceDetectorSession(std::nullptr_t) noexcept {}
        FaceDetectorSession(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Graphics::ImagingInternal::IFaceDetectorSession(ptr, take_ownership_from_abi) {}
        FaceDetectorSession();
    };
