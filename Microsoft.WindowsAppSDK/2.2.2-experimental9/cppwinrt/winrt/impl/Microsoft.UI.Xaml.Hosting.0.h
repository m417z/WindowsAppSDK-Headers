...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IDesktopWindowXamlSource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SiteBridge(void**) noexcept = 0;
            ...
            virtual std::int32_t __stdcall Initialize(struct struct_Microsoft_UI_WindowId) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IWindowsXamlManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall add_XamlShutdownCompletedOnThread(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_XamlShutdownCompletedOnThread(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Hosting::IXamlShutdownCompletedOnThreadEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetDispatcherQueueDeferral(void**) noexcept = 0;
        };
    };
