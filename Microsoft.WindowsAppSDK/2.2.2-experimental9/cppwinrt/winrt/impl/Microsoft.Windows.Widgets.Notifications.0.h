...
{
    enum class AnnouncementActionKind : std::int32_t
    {
        Shown = 0,
        Engaged = 1,
    };
    enum class AnnouncementTextColor : std::int32_t
    {
        Default = 0,
        Dark = 1,
        Light = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Notifications::IFeedAnnouncement>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_PrimaryText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_PrimaryText(void*) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_LightModeIconUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_LightModeIconUri(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_DarkModeIconUri(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_DarkModeIconUri(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_PrimaryTextColor(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_PrimaryTextColor(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_SecondaryTextColor(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SecondaryTextColor(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomAccessibilityText(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CustomAccessibilityText(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSecondaryTextSubtle(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsSecondaryTextSubtle(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ShowBadgeIfUserNotEngaged(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_ShowBadgeIfUserNotEngaged(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_ExpirationTime(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_ExpirationTime(std::int64_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Notifications::IFeedAnnouncementFactory>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateInstance(void*, void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Notifications::IFeedAnnouncementInvokedArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AnnouncementId(void**) noexcept = 0;
