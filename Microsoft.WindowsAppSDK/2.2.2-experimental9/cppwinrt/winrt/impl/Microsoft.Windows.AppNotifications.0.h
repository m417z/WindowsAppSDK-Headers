...
{
    enum class AppNotificationPriority : std::int32_t
    {
        Default = 0,
        High = 1,
    };
    enum class AppNotificationProgressResult : std::int32_t
    {
        Succeeded = 0,
        AppNotificationNotFound = 1,
        Unsupported = 2,
    };
    enum class AppNotificationSetting : std::int32_t
    {
        Enabled = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::IAppNotification>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Payload(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Progress(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Progress(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Expiration(std::int64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Expiration(std::int64_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall get_SuppressDisplay(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_SuppressDisplay(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::IAppNotification2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ConferencingConfig(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_ConferencingConfig(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::IAppNotificationConferencingConfig>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_AudioInputDeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioInputDeviceId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_AudioOutputDeviceId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_AudioOutputDeviceId(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::IAppNotificationConferencingConfigStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsCallingPreviewSupported(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::AppNotifications::IAppNotificationManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Register() noexcept = 0;
            virtual std::int32_t __stdcall Unregister() noexcept = 0;
            virtual std::int32_t __stdcall UnregisterAll() noexcept = 0;
            virtual std::int32_t __stdcall add_NotificationInvoked(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_NotificationInvoked(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall Show(void*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateAsync(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateAsync2(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Setting(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall RemoveByIdAsync(std::uint32_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveByTagAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveByTagAndGroupAsync(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveByGroupAsync(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall RemoveAllAsync(void**) noexcept = 0;
            virtual std::int32_t __stdcall GetAllAsync(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Microsoft_Windows_AppNotifications_IAppNotificationManager
    {
        ...
        auto RemoveByIdAsync(std::uint32_t notificationId) const;
    ...
    {
        auto CreateInstance(std::uint32_t sequenceNumber) const;
    };
