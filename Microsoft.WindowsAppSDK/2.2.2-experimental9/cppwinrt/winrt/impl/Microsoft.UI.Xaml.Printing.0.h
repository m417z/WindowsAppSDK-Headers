...
WINRT_EXPORT namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Printing_IPrintDocument
    {
        ...
        auto SetPreviewPageCount(std::int32_t count, winrt::Microsoft::UI::Xaml::Printing::PreviewPageCountType const& type) const;
        auto SetPreviewPage(std::int32_t pageNumber, winrt::Microsoft::UI::Xaml::UIElement const& pageVisual) const;
