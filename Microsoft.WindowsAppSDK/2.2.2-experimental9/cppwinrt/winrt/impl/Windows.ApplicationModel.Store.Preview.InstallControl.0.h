...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Store::Preview::InstallControl::IGetEntitlementResult2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsAlreadyOwned(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_OrderId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_SkuId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_AvailabilityId(void**) noexcept = 0;
        };
    };
    template <typename D>
