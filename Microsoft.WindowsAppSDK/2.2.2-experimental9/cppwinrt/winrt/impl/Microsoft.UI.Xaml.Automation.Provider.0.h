...
WINRT_EXPORT namespace winrt::impl
{
    ...
    struct consume_Microsoft_UI_Xaml_Automation_Provider_ITextRangeProvider
    {
        ...
        auto Move(winrt::Microsoft::UI::Xaml::Automation::Text::TextUnit const& unit, std::int32_t count) const;
        auto MoveEndpointByUnit(winrt::Microsoft::UI::Xaml::Automation::Text::TextPatternRangeEndpoint const& endpoint, winrt::Microsoft::UI::Xaml::Automation::Text::TextUnit const& unit, std::int32_t count) const;
