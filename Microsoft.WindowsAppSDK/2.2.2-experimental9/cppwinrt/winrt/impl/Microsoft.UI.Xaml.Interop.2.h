...
WINRT_EXPORT namespace winrt::Microsoft::UI::Xaml::Interop
{
    ...
    struct WINRT_IMPL_EMPTY_BASES NotifyCollectionChangedEventArgs : winrt::Microsoft::UI::Xaml::Interop::INotifyCollectionChangedEventArgs
    {
        ...
        NotifyCollectionChangedEventArgs(winrt::Microsoft::UI::Xaml::Interop::NotifyCollectionChangedAction const& action, winrt::Microsoft::UI::Xaml::Interop::IBindableVector const& newItems, winrt::Microsoft::UI::Xaml::Interop::IBindableVector const& oldItems, std::int32_t newIndex, std::int32_t oldIndex);
    };
}
#endif
