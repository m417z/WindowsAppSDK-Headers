...
WINRT_EXPORT namespace winrt::Microsoft::UI::Content
{
    struct WINRT_IMPL_EMPTY_BASES ChildSiteLink : winrt::Microsoft::UI::Content::IChildSiteLink,
        impl::require<ChildSiteLink, winrt::Microsoft::UI::Content::IChildSiteLink2, winrt::Windows::Foundation::IClosable, winrt::Microsoft::UI::IClosableNotifier, winrt::Microsoft::UI::Content::IContentSiteAutomation, winrt::Microsoft::UI::Content::IContentSiteInput, winrt::Microsoft::UI::Content::IContentSiteLink>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES CoreWindowTopLevelWindowBridge : winrt::Microsoft::UI::Content::ICoreWindowTopLevelWindowBridge
    {
        CoreWindowTopLevelWindowBridge(std::nullptr_t) noexcept {}
        CoreWindowTopLevelWindowBridge(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::UI::Content::ICoreWindowTopLevelWindowBridge(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES ProcessStarter : winrt::Microsoft::UI::Content::IProcessStarter
    {
        ...
        static auto StartProcess(param::hstring const& executablePath, param::hstring const& connectionInfo, std::uint32_t& processId);
    };
