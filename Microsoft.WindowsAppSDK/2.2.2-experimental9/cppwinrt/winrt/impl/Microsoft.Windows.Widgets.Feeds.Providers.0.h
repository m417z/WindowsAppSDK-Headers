...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::ICustomQueryParametersRequestedArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall get_FeedProviderDefinitionId(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::ICustomQueryParametersUpdateOptions>
    {
        ...
        {
            virtual std::int32_t __stdcall get_FeedProviderDefinitionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_CustomQueryParameters(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedAnalyticsInfoReportedArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall get_FeedProviderDefinitionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_FeedDefinitionId(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedAnnouncementInvokedTarget>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OnAnnouncementInvoked(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetEnabledFeedProviders(std::uint32_t* __resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall SetCustomQueryParameters(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedManager2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SendMessageToContent(void*, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall TryShowAnnouncement(void*, void*, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedManager3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryRemoveAnnouncementById(void*, void*, void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall OnFeedProviderEnabled(void*) noexcept = 0;
            virtual std::int32_t __stdcall OnFeedProviderDisabled(void*) noexcept = 0;
            virtual std::int32_t __stdcall OnFeedEnabled(void*) noexcept = 0;
            virtual std::int32_t __stdcall OnFeedDisabled(void*) noexcept = 0;
            virtual std::int32_t __stdcall OnCustomQueryParametersRequested(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedProviderInfo>
    {
        ...
        {
            virtual std::int32_t __stdcall get_FeedProviderDefinitionId(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_EnabledFeedDefinitionIds(std::uint32_t* __valueSize, void***) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::Widgets::Feeds::Providers::IFeedResourceRequest>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Headers(void*) noexcept = 0;
        };
    };
