...
{
    enum class PushNotificationChannelStatus : std::int32_t
    {
        InProgress = 0,
        InProgressRetry = 1,
        CompletedSuccess = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::PushNotifications::PushNotificationCreateChannelStatus>{ using type = struct_category<winrt::Microsoft::Windows::PushNotifications::PushNotificationChannelStatus, winrt::hresult, std::uint32_t>; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::PushNotifications::IPushNotificationManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall CreateChannelAsync(winrt::guid, void**) noexcept = 0;
            virtual std::int32_t __stdcall add_PushReceived(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PushReceived(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::PushNotifications::IPushNotificationReceivedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Payload(std::uint32_t* __valueSize, std::uint8_t**) noexcept = 0;
