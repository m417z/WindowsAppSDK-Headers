...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTab>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_TreatAsSecondaryTileId(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_TreatAsSecondaryTileId(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Group(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Group(void*) noexcept = 0;
            virtual std::int32_t __stdcall ReportThumbnailAvailable() noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabCloseRequestedEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Tab(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabCollection>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall MoveTab(void*, std::uint32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabIconStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateFromFontGlyph(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromFontGlyphWithUri(void*, void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateFromImage(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Tabs(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetActiveTab(void*) noexcept = 0;
            virtual std::int32_t __stdcall add_TabSwitchRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TabSwitchRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_TabCloseRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TabCloseRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_TabTearOutRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TabTearOutRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_TabThumbnailRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_TabThumbnailRequested(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall IsTabTearOutSupported(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabTearOutRequestedEventArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Tab(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_WindowId(std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_WindowId(std::uint64_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IWindowTabThumbnailRequestedEventArgs>
    {
        ...
        {
            virtual std::int32_t __stdcall get_Tab(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_RequestedSize(struct struct_Windows_Graphics_Imaging_BitmapSize*) noexcept = 0;
            virtual std::int32_t __stdcall get_Image(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_Image(void*) noexcept = 0;
            virtual std::int32_t __stdcall GetDeferral(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsCompositedOnWindow(bool*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    {
        auto MoveTab(winrt::Windows::UI::Shell::WindowTab const& tab, std::uint32_t index) const;
    };
    ...
    struct consume_Windows_UI_Shell_IWindowTabTearOutRequestedEventArgs
    {
        [[nodiscard]] auto Tab() const;
        [[nodiscard]] auto WindowId() const;
        auto WindowId(std::uint64_t value) const;
