...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::ApplicationModel::Core::IAppListEntry4, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Core::IAppListEntry4>::get_AppInfo, &value);
