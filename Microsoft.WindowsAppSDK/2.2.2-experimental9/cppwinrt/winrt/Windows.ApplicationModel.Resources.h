...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        void* value{};
        consume_general<winrt::Windows::ApplicationModel::Resources::IResourceLoaderStatics4, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Resources::IResourceLoaderStatics4>::GetDefaultPriPath, *(void**)(&packageFullName), &value);
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall GetDefaultPriPath(void* packageFullName, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
