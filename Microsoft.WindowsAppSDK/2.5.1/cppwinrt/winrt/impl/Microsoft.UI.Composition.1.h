...
WINRT_EXPORT namespace winrt::Microsoft::UI::Composition
{
    ...
    struct WINRT_IMPL_EMPTY_BASES ICompositionEngineStatics :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICompositionEngineStatics>
    {
        ICompositionEngineStatics(std::nullptr_t = nullptr) noexcept {}
        ICompositionEngineStatics(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
