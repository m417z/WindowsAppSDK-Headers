...
WINRT_EXPORT namespace winrt::Microsoft::Windows::AI::Text
{
    ...
    struct WINRT_IMPL_EMPTY_BASES GenerateStructuredJsonResponseResult : winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult
    {
        GenerateStructuredJsonResponseResult(std::nullptr_t) noexcept {}
        GenerateStructuredJsonResponseResult(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Windows::AI::Text::IGenerateStructuredJsonResponseResult(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES LanguageModel : winrt::Microsoft::Windows::AI::Text::ILanguageModel,
        impl::require<LanguageModel, winrt::Microsoft::Windows::AI::Text::ILanguageModel2, winrt::Microsoft::Windows::AI::Text::ILanguageModel3, winrt::Windows::Foundation::IClosable>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES LanguageModelLowRankAdapter : winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter,
        impl::require<LanguageModelLowRankAdapter, winrt::Windows::Foundation::IClosable>
    {
        LanguageModelLowRankAdapter(std::nullptr_t) noexcept {}
        LanguageModelLowRankAdapter(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapter(ptr, take_ownership_from_abi) {}
        static auto CreateFromPath(param::hstring const& filePath);
    };
    struct WINRT_IMPL_EMPTY_BASES LanguageModelLowRankAdapterResult : winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult
    {
        LanguageModelLowRankAdapterResult(std::nullptr_t) noexcept {}
        LanguageModelLowRankAdapterResult(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult(ptr, take_ownership_from_abi) {}
    };
    struct WINRT_IMPL_EMPTY_BASES LanguageModelOptions : winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions,
        impl::require<LanguageModelOptions, winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES TextRewriter : winrt::Microsoft::Windows::AI::Text::ITextRewriter,
        impl::require<TextRewriter, winrt::Microsoft::Windows::AI::Text::ITextRewriter2, winrt::Microsoft::Windows::AI::Text::ITextRewriter3>
    {
