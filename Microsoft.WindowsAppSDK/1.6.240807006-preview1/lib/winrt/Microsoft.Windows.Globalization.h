...
{
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) consume_Microsoft_Windows_Globalization_IApplicationLanguagesStatics<D>::Languages() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) consume_Microsoft_Windows_Globalization_IApplicationLanguagesStatics<D>::ManifestLanguages() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Microsoft_Windows_Globalization_IApplicationLanguagesStatics<D>::PrimaryLanguageOverride() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Microsoft_Windows_Globalization_IApplicationLanguagesStatics<D>::PrimaryLanguageOverride(param::hstring const& value) const
    {
